...
echo "Reminder: ".$reminder.'<br />'; 
  ...
  $only_pdfcontent .= '</td></tr>
	...
	if( $can_sendmail == 'yes' ) {
		...
		$to_test = 'sreenuk@rizecorp.net';
		$successMail =JUtility::sendMail($from, $from_name, $to_test, $sub, $body,$mode = 1, $cc=null, $bcc=null, $attachment, $replyto=null, $replytoname=null);
