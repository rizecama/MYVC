...
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login">
	<?php echo $params->get('pretext'); ?>
		  ...
		  <input id="modlgn_username" type="text" name="username" alt="username"  tabindex="1" value="E-Mail" onclick="if(this.value == 'E-Mail') this.value='';" onblur="if(this.value == '') this.value ='E-Mail';" />
		  	<input id="modlgn_passwd" type="password" name="passwd" alt="password"  tabindex="2" value="Password" onclick="if(this.value == 'Password') this.value='';" onblur="if(this.value == '') this.value ='Password';" onfocus="this.value=''"/>
