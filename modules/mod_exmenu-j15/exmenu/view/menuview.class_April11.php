...
//					$txt = '<span class="'. $menuclass .'"'. $elementParameters .'>'. ($menuNode->name != '' ? $menuNode->name : '&nbsp;') .'</span>';
			...
			default:	// formerly case 2
				...
				$menuNode->link = 'http://www.camassistant.com/cms/index.php?option=com_camassistant&controller=vendors&task=vendor_dashboard&Itemid=112';
				else if(isset($user->user_type) && $user->user_type == 12  && $menuNode->name == 'HOME') 
				$menuNode->link = 'http://www.camassistant.com/cms/index.php?option=com_camassistant&controller=rfpcenter&task=dashboard&Itemid=128';
				else if(isset($user->user_type) && $user->user_type == 13 && $menuNode->name == 'HOME')
				$menuNode->link = 'http://www.camassistant.com/cms/index.php?option=com_camassistant&controller=rfpcenter&task=dashboard&Itemid=125'; 
				else
				$menuNode->link = 'http://www.camassistant.com/cms/index.php?option=com_content&view=frontpage&Itemid=1';
