...
$db = & JFactory::getDBO();
	...
	<?php if($path1 == 'emptylogo.jpg'){ ?>

	<a href="index2.php?option=com_camassistant&controller=vendors&task=getuploadpopup" rel="{handler: 'iframe', size: {x: 500, y: 300}}" class="modal"><img width="<?php echo $thumb_width; ?>" height="<?php echo $thumb_height; ?>" src="components/com_camassistant/assets/images/vendors/<?php echo $path1; ?>" /></a>

	<?php } else { 
	?>
	<a href="index2.php?option=com_camassistant&controller=vendors&task=getuploadpopup" rel="{handler: 'iframe', size: {x: 500, y: 300}}" class="modal"><img width="<?php echo $thumb_width; ?>" height="<?php echo $thumb_height; ?>" src="components/com_camassistant/assets/images/vendors/<?php echo $path1; ?>" />
	</a>
<?php /*?><img width="<?php echo $thumb_width; ?>" height="<?php echo $thumb_height; ?>" src="components/com_camassistant/assets/images/vendors/<?php echo $path1; ?>" /><?php */?>
	<?php } ?>
