...
<div id="fontsize">
  <script type="text/javascript">
		...
		document.write('<a href="index.php" title="<?php echo JText::_('Reset font size to default'); ?>" onclick="changeFontSize(-1); return false;" class="reset"><?php 
					if ($params->get('useImg', 1))
		{
		if($template == 'camassistant_left'){
		...
		echo JText::_(' reset');
					...
					document.write('<a href="index.php" title="<?php echo JText::_('Decrease size'); ?>" onclick="revertStyles(); return false;" class="smaller"><?php 
					if ($params->get('useImg', 1))
		{
		if($template == 'camassistant_left'){
