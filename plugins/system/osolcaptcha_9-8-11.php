...
class plgSystemOSOLCaptcha extends JPlugin
{
	...
	<input type="hidden" name="tax_id" value="<?php echo $_REQUEST['tax_id']; ?>" />
	<?php
	//print_r($_REQUEST); exit;
	$mainframe->redirect('index.php?option=com_camassistant&controller=propertymanager&view=propertymanager&task=submit_licid&Itemid=105&tax_id='.$_REQUEST['tax_id'].'&taxid2='.$_REQUEST['taxid2'].'&taxid1='.$_REQUEST['taxid1'].'&Itemid='.$_REQUEST['Itemid']);
...
//$response->error_message = 'Invalid username and password';
  ...
  <tr>
	...
	".($vertical?"</tr><tr>":"")."
    <td align=\"left\" valign=\"middle\" ><input type=\"text\" name=\"osolCatchaTxt\" id=\"osolCatchaTxt{$GLOBALS['totalCaptchas']}\"  class=\"inputbox required validate-captcha\" />&nbsp;
