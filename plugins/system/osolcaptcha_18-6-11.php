	   ...
	   function onAfterRoute()
        {
			...
			elseif(isset($_REQUEST['osolCatchaTxt']) && !$this->confirm($osolCatchaTxt,$osolCatchaTxtInst))
			{
				...
				$_SESSION['vemail']= $_REQUEST['vemail']; 
				$_SESSION['bill_companyname']= $_REQUEST['bill_companyname']; 
				$_SESSION['company_phone']= $_REQUEST['company_phone']; 
				$_SESSION['phone_ext']= $_REQUEST['phone_ext']; 
				$_SESSION['is_checked']= $_REQUEST['is_checked']; 
				$_SESSION['name_on_card']= $_REQUEST['name_on_card']; 
				$_SESSION['CardType']= $_REQUEST['CardType']; 
				$_SESSION['CardNumber']= $_REQUEST['CardNumber']; 
				$_SESSION['ExpMon']= $_REQUEST['ExpMon']; 
				$_SESSION['ExpYear']= $_REQUEST['ExpYear']; 
				$_SESSION['verify_code']= $_REQUEST['verify_code']; 
				$_SESSION['pay_amount']= $_REQUEST['pay_amount']; 
				...
				$_SESSION['company_address']= $_REQUEST['company_address']; 
				$_SESSION['company_addresss']= $_REQUEST['company_addresss']; 
				$_SESSION['city']= $_REQUEST['city']; 
				$_SESSION['states']= $_REQUEST['states']; 
				$_SESSION['zipcode']= $_REQUEST['zipcode']; 
				$_SESSION['address']= $_REQUEST['address']; 
				$_SESSION['address2']= $_REQUEST['address2']; 
				$_SESSION['bill_city']= $_REQUEST['bill_city']; 
				$_SESSION['bill_zipcode']= $_REQUEST['bill_zipcode']; 
				$_SESSION['checkbox']= $_REQUEST['checkbox']; 
				$_SESSION['checkbox2']= $_REQUEST['checkbox2']; 
				$_SESSION['not_interest_RFP']= $_REQUEST['not_interest_RFP']; 
				$_SESSION['interest_RFP_alerts']= $_REQUEST['interest_RFP_alerts']; 
