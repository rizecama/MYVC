...
$daysbefore14=date('Y-m-d', strtotime('+30 days', strtotime($today)));
...
LEFT JOIN #__cam_vendor_workers_companies_insurance as D ON D.vendor_id=u.id
 WHERE u.user_type = 11 AND ((A.OLN_expdate = '".$daysbefore14."' AND A.OLN_expdate != '00-00-0000') OR (B.PLN_expdate = '".$daysbefore14."' AND B.PLN_expdate != '00-00-0000') OR (C.GLI_end_date = '".$daysbefore14."' AND C.GLI_end_date != '00-00-0000') OR (AI.aip_end_date = '".$daysbefore14."' AND AI.aip_end_date != '00-00-0000') OR (WC.wc_end_date = '".$daysbefore14."' AND WC.wc_end_date != '00-00-0000') OR (D.WCI_end_date = '".$daysbefore14."' AND D.WCI_end_date != '00-00-0000'))  ORDER BY u.id ";
	...
	class checkstatus
		{
			public function sendmail_vendor($vendorid,$document)
			{
					...
					$mailsubject = 'Your Compliance Document is about to Expire - 30';
