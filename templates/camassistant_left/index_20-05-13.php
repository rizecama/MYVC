...
$.src='//cdn.zopim.com/?mDjQ1AfRYEtk20ocaTBp5ItMq6mbGLBu';z.t=+new Date;$.
...
<?php } ?>
			<?php if($user->user_type == '11') : ?>
					...
					<?PHP  if($vendor_GLI_compliance_alert['W9_exist'] != 0 && $vendor_GLI_compliance_alert['GLI_exist'] != 0 && $PLN_needed == 'no') {  ?>
