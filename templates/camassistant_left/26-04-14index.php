...
<jdoc:include type="modules" name="feedback" />
			...
			<?php if($_REQUEST['controller']=='rfpcenter' || $_REQUEST['controller']=='rfp' || $_REQUEST['controller']=='boardmembers' || $_REQUEST['task']=='manage_properties' || $_REQUEST['task']=='customer_edit_form' || $_REQUEST['task'] == 'dm_rfps_by_managers' || $_REQUEST['task'] == 'vendorscenter' || $_REQUEST['controller']=='addproperty' || $_REQUEST['controller']=='vendorscenter' || $_REQUEST['controller']=='sorting' || $_REQUEST['controller']=='vinvitations' || $_REQUEST['task'] =='company_edit_form' || ($_REQUEST['controller']=='documents' && $user->user_type != '11' ) ) { ?>
