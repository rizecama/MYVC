...
// Just before the close of <body> HERE: templates/camassistant_left/index.php
//
//====================================================//
if(typeof(jQuery) !== 'undefined'){
	...
	jQuery(function(){
		...
		var details = jQuery(document).find(".cid214 .prop_detailsclosed, .cid214 .awardprop_details, .cid214 .prop_details");

		details.each(function(){
			//.addednumclosed li:eq(2)
			jQuery(this).on('click', 'li a:contains("DOWNLOAD PROPOSALS")', function(e){
				...
				var modal = '<div id="js-modal" class="ag-modal">'
							+'<div class="ag-modal-inner">'
								...
								+'<img src="/live/templates/camassistant_left/images/16-04-11final_loading_big.gif" alt="Loading gif"/>'	
							+'</div><!-- /.modal-inner-->'
						+'<style>'
						+'.ag-modal{'
							+'position: fixed;'
