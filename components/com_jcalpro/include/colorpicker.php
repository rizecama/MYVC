...
$colorid = isset( $_GET['id'] ) ? $_GET['id'] : 'color';
$colorpickerbgid = isset( $_GET['id'] ) ? 'colorpickerbg_'.$_GET['id'] : 'colorpickerbg';
?>
...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function setColor(k) {
				opener.document.getElementById('<?php echo $colorid; ?>').value = colors[k];
				opener.document.getElementById('<?php echo $colorpickerbgid; ?>').style.backgroundColor= opener.document.getElementById('<?php echo $colorid; ?>').value;
				window.close();
			}
