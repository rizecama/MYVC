...
/**
 *
 * @version   $Id: shDecorator.php 667 2011-01-24 21:02:32Z jeffchannell $
...
class ShAbstractDecorator {
	...
	public function __get( $property) {
		...
		if (property_exists( $this->_decorated, $property) || $this->_decoratedIsDecorator) {
			...
			throw new Exception ('Trying to get non-existing property for class ' . $this->_decoratedClass);
		}
	}
