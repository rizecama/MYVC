...
DEFINE('_RSFORM_BACKEND_FORMS_EDIT_STARTLINETASK','Start Line Item Task'); 
DEFINE('_RSFORM_BACKEND_FORMS_EDIT_ENDLINETASK','End Line Item Task'); // added on 07-07-2011  the defined names are appear as component name on the components panel
