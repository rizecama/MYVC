...
if($link == 'http://www.camassistant.com/cms/index.php?option=com_content&view=article&id=51:terms-of-service-and-user-agreement'){
$link = "<a href=$link>$link</a>";
$msg = "This is an e-mail from (CAMassistant.com) sent by ".$from.". You may review the CAMASSISTANT.COM Terms of Service and User Agreement here:<br>".$link."";
}

else if($link == 'http://www.camassistant.com/cms/index.php?option=com_content&view=article&id=52:privacy-policy'){
$link = "<a href=$link>$link</a>";
$msg = "This is an e-mail from (CAMassistant.com) sent by ".$from." You may review the CAMASSISTANT.COM Privacy Policy here:<br>".$link."";
}
...
$SiteName = '';
		...
		// Send the email
		if ( JUtility::sendMail($from, $sender, $email, $subject, $body, $mode = 1) !== true )
		{
			JError::raiseNotice( 500, JText:: _ ('EMAIL_NOT_SENT' ));
			return $this->mailto();
		}
