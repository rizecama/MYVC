...
<script type="text/javascript" src="<?php echo JURI::root().'components/com_jefaqpro/assets/js/jquery-latest.js'; ?>"></script>
...
//G("#mymenu1-4-label").attr('aria-expanded','false'):
//G("#mymenu1-4-label").addclass('active'):
</script>
...
<script type="text/javascript">
$("#mymenu1-<?php echo $_REQUEST['faq'];?>-label").attr('aria-expanded','true');
$("#mymenu1-<?php echo $_REQUEST['faq'];?>-label").addClass('active');
$("#mymenu1-<?php echo $_REQUEST['faq'];?>-label").next().removeClass('hidden');
</script>