...
<P style="color: #008000;
    ...
    line-height: 40px;
    margin-top: 50px;
    text-align: left;">SORRY, PAGE NOT FOUND.<br /><br />

TRYING TO REGISTER?<br />
PLEASE GO TO THE HOME PAGE TO REGISTER AS A VENDOR OR A MANAGER.</P>
<?php /*?><form action="<?php echo JRoute::_( 'index.php?option=com_user' ); ?>" method="post" id="josForm" name="josForm" class="form-validate">
