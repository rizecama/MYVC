...
$user = JFactory::getUser();
		...
		$mailfrom = $user->email;
		$fromname = $user->name;
		$recipient = 'vendorratings@camassistant.com'; /* pm2.rizecorp@gmail.com */
		$mailsubject = 'Survey Submitted';
		$body = "Hello<br/><br/>";
		$body .= "A new survey is submitted from ".$fromname;
		$sent = JUtility::sendMail($mailfrom, $fromname, $recipient, $mailsubject, $body,$mode = 1);
				//if(!$sent){ echo "Mail not sent"; } else { echo "Mail Sent";}
		//echo JText::_('PUBLIC_SURVEYS'); ?></div>
<ul>
