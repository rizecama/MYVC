...
<div class="kblock kcategories-<?php echo intval($section->id) ?>">
	...
	<div class="sateeshkcontainer" id="catid_<?php echo intval($section->id) ?>">
		<div class="kbody">
<table class="kblocktable<?php echo $htmlClassBlockTable ?>" id="kcat<?php echo intval($section->id) ?>">
	...
	?>
		...
		<?php endif; ?>
			...
			if ($last->exists()) { ?>
			<?php /*?><td class="kcol-mid kcol-kcatlastpost">
			...
			<?php } else { ?>
			<?php /*?><td class="kcol-mid kcol-knoposts"><?php echo JText::_('COM_KUNENA_NO_POSTS'); ?></td><?php */?>
			<?php } ?>
		</tr>
		<?php } } ?>
</table>
