...
<div class="kmsg-header kmsg-header-left" style="border-bottom:0px; margin-top:1px; border-right:none">
	<h2 style="background:#fff;">
		...
		<span class="kmsg-id-left">
			<a style="color:#636363 !important; line-height:23px;" class="newtopic" href="index.php?option=com_kunena&view=category&catid=2&Itemid=233"></a>
		</span>
		<span class="kmsg-id-left" style="background: url('templates/camassistant_left/images/list-bg-news.gif') no-repeat scroll right center transparent; padding-right:10px; margin-bottom:0px; line-height:22px;">
