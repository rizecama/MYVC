...
<tr class="<?php echo $this->getTopicClass('k', 'row') ?>">
	...
	<td class="kcol-mid kcol-ktopictitle">
		...
		<?php /*?><div class="ktopic-details">
			<span class="ktopic-categorysateesh"> <?php echo JText::sprintf('COM_KUNENA_CATEGORY_X', $this->getCategoryLink ( $this->topic->getCategory() ) ) ?></span>
		</div><?php */?>
