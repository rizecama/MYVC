...
//		$path = JURI::root().'components/com_camassistant/assets/images/vendorcompliances';
	...
	function get_pdf_open_upld_cert()
	{
		...
		$path = '/home/allen/public_html/live/components/com_camassistant/assets/images/vendorcompliances/'.$vendorname.'/'.$doc_type;
		$doc_name = $path."/".$filename;
...
//		$doc_name = $path."/".$filename;
	...
	function get_vendor_proposal_summary()
	{
		...
		$prp_Draft_sql = "SELECT VP.id, VP.Alt_bid, R.rfp_type,R.unawardeddate,VP.proposedvendorid,R.awardeddate, VP.publish, R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime, P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		WHERE VP.proposedvendorid=".$user->id." AND (VP.proposaltype = 'Draft' OR VP.proposaltype = 'ITB' OR VP.proposaltype = 'review') AND STR_TO_DATE(R.proposalDueDate, '%m-%d-%Y') >= '".$today."'  order by STR_TO_DATE(R.proposalDueDate, '%m-%d-%Y') DESC limit 0,3";
		...
		$today = date('m-d-Y');
		$prp_Submitted_sql = "SELECT VP.id, VP.Alt_bid, R.rfp_type,R.unawardeddate,VP.publish, R.awardeddate,VP.proposedvendorid, R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime,P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		WHERE VP.proposedvendorid=".$user->id." AND (VP.proposaltype = 'Submit' OR VP.proposaltype = 'resubmit') AND STR_TO_DATE(R.proposalDueDate, '%m-%d-%Y') >= '".$today."' and R.rfp_type != 'closed' and R.close_vendor != 'closed' order by R.proposalDueDate limit 0,3";
		...
		$prp_Awarded_sql = "SELECT VP.id, VP.publish, R.rfp_type,R.unawardeddate,R.awardeddate,VP.Alt_bid,VP.proposal_total_price, VP.proposedvendorid, R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime, P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		WHERE VP.proposedvendorid=".$user->id." AND VP.proposaltype = 'Awarded' order by VP.id limit 0,3";
		...
		$prp_Unawarded_sql = "SELECT VP.id,VP.Alt_bid,VP.proposal_total_price, R.rfp_type,R.awardeddate,R.unawardeddate,VP.proposedvendorid, R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime, P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		...
		$prp_Review_sql = "SELECT VP.id,VP.Alt_bid, VP.proposedvendorid,R.unawardeddate, R.awardeddate,R.rfp_type,R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime, P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		WHERE VP.proposedvendorid=".$user->id." AND VP.proposaltype = 'Submit' and R.rfp_type = 'closed' order by VP.id limit 0,3";
...
//echo "<pre>"; print_r($All_prp_Draft_summary); exit;
	...
	function _buildQuery($Prp_type)
	{
		...
		$condition = " AND (VP.proposaltype = '".$Prp_type."' )";
		 $query = "SELECT VP.id,VP.Alt_bid,VP.proposedvendorid, R.close_vendor, R.rfp_type, VP.publish, VP.proposal_total_price ,R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime, P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
...
//		echo ' states <pre>'; print_r($states);exit;
	   ...
	   function get_vendor_proposal_summary_dashboard()
	{
		...
		$today = date('m-d-Y');
		//query to get Drfat proposals
		$prp_Draft_sql = "SELECT VP.id, VP.Alt_bid, R.rfp_type,VP.proposedvendorid,R.close_vendor, P.divcounty,VP.publish, R.id as rfp_id, R.projectName, R.proposalDueDate, R.proposalDueTime, P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		WHERE VP.proposedvendorid=".$user->id." AND (VP.proposaltype = 'Draft' OR VP.proposaltype = 'ITB' OR VP.proposaltype = 'review') AND VP.bidfrom = '' AND STR_TO_DATE(R.proposalDueDate, '%m-%d-%Y') >= '".$today1."'  order by R.proposalDueDate,R.proposalDueTime  DESC ";
		...
		//query to get submitted proposals
		$today = date('m-d-Y');
		$prp_Submitted_sql = "SELECT VP.id, VP.Alt_bid, R.close_vendor,VP.publish, P.divcounty,VP.proposedvendorid, R.id as rfp_id, R.projectName, R.proposalDueDate, R.rfp_type, R.proposalDueTime,P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		...
		$prp_Submitted_sql = "SELECT VP.id, VP.Alt_bid, VP.publish,R.close_vendor, P.divcounty,VP.proposedvendorid, R.id as rfp_id, R.projectName, R.proposalDueDate, R.rfp_type, R.proposalDueTime,P.id as Prperty_id, P.property_name  FROM  #__cam_vendor_proposals as VP
		LEFT JOIN #__cam_rfpinfo as R ON R.id = VP.rfpno
		LEFT JOIN #__cam_property as P ON R.property_id = P.id
		WHERE VP.proposedvendorid=".$user->id." AND (VP.proposaltype = 'Submit' OR VP.proposaltype = 'resubmit') order by R.proposalDueDate,R.proposalDueTime  DESC ";
...
$query = "SELECT A.id, A.rfp_id,A.prp_id,R.projectName,R.proposalDueDate,A.not_interested,P.property_name,P.property_name,P.divcounty,R.industry_id,R.proposalDueTime,A.status  FROM jos_cam_vendor_availablejobs as A
				  ...
				  WHERE I.rfpid = A.rfp_id AND I.vendorid = A.user_id AND A.status = 0 AND R.rfp_type = 'rfp' AND  A.user_id=".$user->id." AND R.publish=1 and A.publish=1 order by R.proposalDueDate,R.proposalDueTime  ASC " ;
