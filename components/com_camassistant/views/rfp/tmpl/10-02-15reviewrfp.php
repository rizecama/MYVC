...
<table cellpadding="0" cellspacing="0" border="0">
	<?php
		if($w9data){ $w9_main = 'checked="checked"'; $class_w9="styled"; 
	?>
	<tr><td><input type="checkbox" value="yes" id="w9" class="<?php echo $class_w9; ?>" name="w9" <?php echo $w9_main; ?> /></td><td><strong>W9</strong></td></tr>
	<?php } ?>
...
$ratecount = "SELECT V.apple FROM `#__cam_vendor_proposals` as U, `#__cam_rfpinfo` as V where U.proposedvendorid=".$am->vendorid." and V.apple!=0 and V.apple_publish=0 and U.proposaltype='Awarded' and U.rfpno = V.id ";
	...
	<div class="search-panel-image_rfp_inv compliant_vendor_inv" style="margin-top:0px; padding-top:0px;">
	  ...
	  <p align="center" style="color:<?php echo $spe_color; ?>; display:block; margin-bottom:7px; font-weight:bold;">
	   <?php if($globals != 'fail'){ ?>
	<a id="<?php echo $compliant_id; ?>" class="modal" rel="{handler: 'iframe', size: {x: 650, y: 700}}" href="index.php?option=com_camassistant&controller=rfp&task=getcompliance&rfpid=<?php echo $rfpinfo->id; ?>&vendorid=<?php echo $am->vendorid; ?>" title="<?php echo $title; ?>"><?php echo $images_text ; ?></a>
	<?php } else {
			echo "N/A";
			}?>
			 </p>
