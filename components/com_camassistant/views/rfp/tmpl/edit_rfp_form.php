	...
	//var id2=1;
		//id2++;
			...
			var divIdName2 = "newSelector"+num2;
                        ...
                        newitem2='<table style="margin-top:10px;"><tr><input type="hidden" name="old_docids[]" /><td><span id="delimg'+id2+''+num2+'" style="display:none" title="Remove From RFP"><img src="<?php echo Juri::base(); ?>templates/camassistant_left/images/red.png" alt="delete" style="cursor:pointer;" onclick="javascript:deletelineupload('+id2+''+num2+','+num2+');"/></span></td><td><span id="uploadfile'+id2+''+num2+'" style="float:left;width:auto;padding-right:5px; font-size:14px;"></span></td><input type="hidden" value=" " name="linetask_uploads_2'+id2+'[]" id="lineuploads'+id2+''+num2+'"  ></tr></table>';
...
$managerid = $db->loadResult();
 ...
 $use_detail="SELECT name,lastname,phone,extension,email FROM #__users where id='".$this->rfpinfo->cust_id."'";
...
<tr><td></td><td><p style="margin-left:7px;">Open bidding allows you to see a Vendor’s quote (pricing) as soon as it is submitted into the system.</p></td></tr>
...
<tr><td></td><td><p style="margin-left:7px;">Sealed bidding allows you to see a Vendor’s quote (pricing) ONLY after you manually close the RFP.</p></td></tr></table>
</div>
...
<li><table cellpadding="0" cellspacing="0"><tr><td><input type="checkbox" value="yes" name="cert_holder" style="margin-left:0px;" <?php echo $cert; ?> class="<?php echo $class_cert_holder2; ?>"  /></td><td> MyVendorCenter listed as Cert. Holder</td></tr></table></li>
 ...
 ?>
		...
		<li>Disease - Policy Limit: <input type="text" onKeyup="if(isNaN(parseInt(this.value))) { alert('Please enter valid number'); this.value=''; }" onClick="if(this.value == '0.00') this.value='';" onChange="javascript: add_commas_special(this,this.value);" value="<?php echo number_format($workdata->disease_policy,2); ?>" name="disease_policy" id="disease_policy" /></li>
		<li>Disease - Each Employee: <input type="text" onKeyup="if(isNaN(parseInt(this.value))) { alert('Please enter valid number'); this.value=''; }" onClick="if(this.value == '0.00') this.value='';" onChange="javascript: add_commas_special(this,this.value);" value="<?php echo number_format($workdata->disease_eachemp,2); ?>" name="disease_eachemp" id="disease_eachemp" /></li>
	...
	<?php
		if($omidata){ $omi_main = 'checked="checked"'; $class_omi = 'styled'; }
		else{ $display_omi = 'none';} 
	?>
	<tr height="25"><td><input type="checkbox" value="yes" id="errorsomissions" class="<?php echo $class_omi; ?>" name="errorsomissions" <?php echo $omi_main; ?> /></td><td><strong>Errors & Omissions</strong></td></tr>
	
	<tr><td></td><td>
	<ul class="pre_umbrella" style="list-style-type:none; display:<?php echo $display_omi; ?>">
		<li>Each Claim: <input type="text" onKeyup="if(isNaN(parseInt(this.value))) { alert('Please enter valid number'); this.value=''; }" onClick="if(this.value == '0.00') this.value='';" onChange="javascript: add_commas_special(this,this.value);" value="<?php echo number_format($omidata->each_claim,2); ?>" name="each_claim" id="each_claim" /></li>
		<li>Aggregate: <input type="text" onKeyup="if(isNaN(parseInt(this.value))) { alert('Please enter valid number'); this.value=''; }" onClick="if(this.value == '0.00') this.value='';" onChange="javascript: add_commas_special(this,this.value);" value="<?php echo number_format($omidata->aggregate_omi,2); ?>" name="aggregate_omi" id="aggregate_omi" /></li>
		<?php if($omidata->certholder_omi == 'yes'){ $waiver_omi = 'checked="checked"'; $class_certholder_omi = 'styled'; }?>
		<li><table cellpadding="0" cellspacing="0"><tr><td><input type="checkbox" value="yes" name="certholder_omi" style="margin-left:0px;" <?php echo $waiver_omi; ?> class="<?php echo $class_certholder_omi; ?>" /></td><td> MyVendorCenter listed as Cert. Holder</td></tr></table></li>
		</ul>
	</td></tr>
...
<div class="lineitem_pan_rfpline">
<h3 class="lineitemheading">Line Item #<span id="LM_<?PHP echo $i; ?>"><?PHP echo $i; ?></span>:</h3>
...
$p_name= str_replace(' ','_',$property->property_name); ?>
 <?php if($i>=2){ ?>
<p style="height:20px;"></p><div style="float:left;">  <a class="upload_new_files_rfp" href="javascript:addEventa2(<?php echo $i; ?>);">
</a></div>
<?php } else{ ?>
<p style="height:20px;"></p><div style="float:left;"><a class="upload_new_files_rfp" href="javascript:addEventa2(<?php echo $i; ?>);"></a></div>
<?php } ?>
 ...
 <?php } ?>
<br/><div id="newdiva2<?php echo $i; ?>"></div><?php //echo '<pre>'; print_r($linetaks); ?>
