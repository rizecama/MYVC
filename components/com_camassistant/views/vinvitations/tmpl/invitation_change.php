...
<label class="smallimage_new"></label>
<div class="invite-newvenodor">
<label><span style="padding-right: 20px;">EMAIL</span></label>
<div class="smallimage_new">&nbsp;</div>
<input type="text" value="<?php echo $user_info->email_new?>" name="email" id="email">
</div>
...
<div class="smallimage_new">&nbsp;</div>
<input  type="text"  id="subject" name="subject" value="<?php echo $user_info->subject_new?>">
</div>
...
generate_wysiwyg('ctl00_CPHContent_txtComments');
 ...
 <tr height="5"></tr>
 <tr>
 <td align="right"><a href="javascript:void(0);" onClick="window.location.reload()" id="cancellink"><img src="templates/camassistant_left/images/CancelMini.png" /></a> <a id="saveoption" href="javascript:void(0);" style="font-weight:bold; color: #7ab800;"><img src="templates/camassistant_left/images/SaveMini.png" /></a></td></tr>
<tr height="10"></tr>
