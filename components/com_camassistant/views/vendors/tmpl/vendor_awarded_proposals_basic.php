				...
				else
				{
					...
					$standards = "<span style='color:#ff6264; font-weight:bold;'>No</span>";
						...
						$standards = "<span>N/A</span>";
                         ...
                         $htmlcontent .= '<tr><td height="10" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7;  font-weight:bold; text-align:center; "><table cellpadding="2" cellspacing="1"><tr><td>'.$onfile.'</td></tr></table></td></tr><tr><td height="16" bgcolor="#f3f9e8" style="font-size:24px; border:0.5px solid #b7b7b7; text-align: center; font-weight:bold;">'.$BID_Vendors_info[$v]->c_status.'</td></tr><tr><td height="45" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; ">'.$RFP_details_inhouse1.'</td></tr>';
								 ...
								 for($TP=0; $TP<$cnt_prices; $TP++)
								 {
								  ...
								  // {
                                                                      ...
                                                                      //  }//else if($cnt_Task_Prices == '0')
                                                                        ...
                                                                        if($cnt_Task_Prices == 0)
									 {
                                                                             $lineitemprice .= '<tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7;" height="50" ><p style="font-size:24px; font-family:Arial Black; color:#000;"><br/>0.00</p></td></tr>';
                                                                        }
...
//echo '<pre>'; print_r($star_final);
							...
							$as = '<span style="color:#ff6264; font-size:42px">*</span>';
                                                       ...
                                                       // echo $as;
				  $lineitemprice .= '<tr><td align="center" valign="middle" height="50" style="border:0.5px solid #b7b7b7; font-size:35px; font-family:Arial Black; color:#000; font-weight:bold;"><br/><br/>$'.$TASKS_summary[$TP]->task_price[$B]->item_price.''.$as.'</td></tr>';
										 // }
		...
		//Special basic request
		 ...
		 $line_cnt=count($RFP_NOTES_summary);
							...
							// $RFP_NOTES_summary[$li]->task_desc = nl2br(wordwrap($RFP_NOTES_summary[$li]->task_desc, 140, "\n"));
							 ...
							 $htmlcontent3 .='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:40px"><tr><td colspan="2"><table width="550px" cellspacing="0" cellpadding="0" valign="middle"><tr><td width="100%" height="15" style="font-size:32px; text-align: left; vertical-align:middile; color:#000; font-weight:bold;" valign="middle"><font style="font-size:24px;">'.$RFP_NOTES_summary[$li]->linetaskname.'</font></td></tr></table></td></tr><tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$RFP_NOTES_summary[$li]->task_desc.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">';
		...
		if($count>0){ for($v=0; $v<$count; $v++) {
		 ...
		 $add_notes = 'SELECT add_notes FROM #__cam_rfpsow_addnotes WHERE spl_req="Yes" AND rfp_id = '.$BID_Vendors_info[$v]->rfpno.' AND vendor_id= '.$BID_Vendors_info[$v]->proposedvendorid.' AND Alt_bid!="yes"';
		  ...
		  //echo '<pre>'; print_r( $add_notes1);
		   if($add_notes1 != '')
		 $htmlcontent4 .= '<font style="font-size:24px; font-weight:bold;">PROPOSAL NOTES:</font><br/>'.html_entity_decode($add_notes1).'';
...
/***************************************** RFP LINE ITEMS AND VENDOR RESPONSES ****************************************/
  ...
  $pdf->AddPage();
		 $htmlcontent5 ='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:40px"><tr><td colspan="2"><table width="550px" cellspacing="0" cellpadding="0" valign="middle"><tr><td width="100%" height="15" style="font-size:32px; text-align: left; vertical-align:middile; color:#000; font-weight:bold;" valign="middle"><font style="font-size:24px;">'.$RFP_NOTES_summary[$li]->linetaskname.'</font></td></tr></table></td></tr><tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$RFP_NOTES_summary[$li]->task_desc.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">';
...
$add_notes = 'SELECT add_notes FROM #__cam_rfpsow_addnotes WHERE spl_req="Yes" AND rfp_id = '.$BID_Vendors_info[$w]->rfpno.' AND vendor_id= '.$BID_Vendors_info[$w]->proposedvendorid.' AND Alt_bid="yes"';
		  ...
		  //echo '<pre>'; print_r( $add_notes1);
		   if($add_notes1 != '')
		 $warranrtyinformation .= '<br /><font style="font-size:24px; font-weight:bold;">PROPOSAL NOTES:</font><br/>'.html_entity_decode($add_notes1).'';
		 else
