...
<div class="lic-pan">
    <h2>WORKERS COMPENSATION / EMPLOYER`S LIABILITY POLICY - <?PHP echo $WCI_title; ?></h2>
    <div class="clear"></div>
    <div class="lic-pan-left">
      ...
      <div class="rmv"><div class="file_input_div"><span class="upload<?PHP echo $WCI_title; ?>"  id="uploadnewWCI<?PHP echo $WCI_title; ?>"><a href="javascript:doc_upload('<?PHP echo $WCI_title; ?>','WCI','');" id="upload_compliance"></a></span>  <span class="remove<?PHP echo $WCI_title; ?>"  style="width:160px; left:-6px;"><a href="javascript:doc_upload_second('<?PHP echo $WCI_title; ?>','WCI','','second');" id="update_compliance" id="removeWCI<?PHP echo $WCI_title; ?>" style="display:none;">
       </a></span>
              <input type="hidden" name="dWCI<?PHP echo  $WCI_title; ?>" id="dWCI<?PHP echo  $WCI_title; ?>"  value="" />
			  </div>
   <input type="hidden" class="file_input_textbox" name="WCI_upld_cert[]" id="WCI_upld_cert<?PHP echo $WCI_title; ?>"  value="" />

<div class="reeditbuttons" id="savedocs_vendor">
<div class="GLI<?PHP echo $WCI_title; ?>">
<a href="javascript: Alt_saveassubmit('WCI<?PHP echo $WCI_title; ?>');" class="save_complaince"></a>
