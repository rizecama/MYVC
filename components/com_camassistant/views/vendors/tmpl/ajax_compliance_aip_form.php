...
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
    ...
    <div class="lic-pan-rightnew">
	  ...
	  <div class="in-pan">
        ...
        <input type="text" size="10" name="aip_end_date[]" id="aip_end_date<?PHP echo $AIP_title; ?>" value="" /><span style="color:red; font-size: 20px;">*</span><script type="text/javascript">G('#aip_end_date<?PHP echo $AIP_title; ?>').datepicker({dateFormat: 'mm-dd-yy', changeYear: true,minDate: "-1y",maxDate: "+5y",changeMonth:true});</script>
      </div>
	  <div class="in-pan1">
