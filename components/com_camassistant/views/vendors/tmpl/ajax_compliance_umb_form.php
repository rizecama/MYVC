...
<div class="lic-pan">
    <h2>UMBRELLA LIABILITY POLICY - <?PHP echo $UMB_title; ?></h2>
   <div class="clear"></div>
    <div class="lic-pan-left">
      <div class="imag-display" id="imagdisplayUMB<?PHP echo $UMB_title; ?>"><span id="nofileuploaded">NO FILE UPLOADED</span></div>
      <div class="rmv"><div class="file_input_div"  ><span class="upload<?PHP echo $UMB_title; ?>"  id="uploadnewUMB<?PHP echo $UMB_title; ?>"><a href="javascript:doc_upload('<?PHP echo $UMB_title; ?>','UMB','');" id="upload_compliance"></a></span> <span class="remove<?PHP echo $UMB_title; ?>"><a href="javascript:doc_upload_second('<?PHP echo $UMB_title; ?>','UMB','','second');" id="update_compliance" id="removeUMB<?PHP echo $UMB_title; ?>" style="display:none;">
       </a></span>
...
<div class="UMB3">
<a href="javascript: Alt_saveassubmit('UMB<?PHP echo $UMB_title; ?>');" class="save_complaince"></a>
...
<script type="text/javascript">G('#UMB_expdate<?PHP echo $compliance; ?>').datepicker({dateFormat: 'mm-dd-yy',changeYear: true,changeMonth:true,minDate: "-1y", maxDate: "+5y"});</script>
</div>
<div class="in-pan1">
