...
.rmv{ padding:0px; margin-left:-2px;}
...
#w9document{margin: 0px 0px 0px 8px; float:left;}
#w9document2{margin: 0px 0px 0px 8px; float:left;}
.othercheck > input {
  float: left;
  margin-top: 11px;
}
...
<div class="lic-pan">
    ...
    <div class="lic-pan-left">
      ...
      <div class="rmv" style="padding:0px;"><?PHP if($W9_data->w9_upld_cert != '') {?>
           <span class="uploadW91"  id="uploadW91">
		   <a class="W91" style="display:none;" id="update_compliance" href="javascript:doc_upload('1','W9','<?PHP echo $W9_data->id; ?>');"></a></span>
  
      <?php  } else { ?>

           <span class="uploadW91"  id="uploadW91">
		   <a class="W91" style="display:none;" href="javascript:doc_upload('1','W9','<?PHP echo $W9_data->id; ?>');" onClick="" id="upload_compliance" ></a></span>
...
<a href="javascript:del_upld_cert('W9_upld_cert1','<?PHP echo $W9_data->w9_upld_cert; ?>','compliance_w9docs','W9','<?PHP echo $W9_data->id; ?>','1')" class="edit_complaince" ></a><br /><a href="javascript:cleardocument('W9','<?PHP echo $W9_data->id; ?>','1')" class="clear_complaince" ></a>  
</div>

<div style="display:none;" id="w9document2" class="W91">
<a href="javascript: Alt_saveassubmit('W9');" class="save_complaince"></a><br />
<a href="javascript:cenceleditdocs();" class="cancel_compliance_w9"></a>
</div>
...
G.post("index2.php?option=com_camassistant&controller=proposals&task=vendor_proposal_edit_format_val", {fieldvalue:""+x+""}, function(data){
   ...
   <div class="rmv" style="float:left; width:23%; padding:0px;"><?PHP if($GLI_data[0]->GLI_upld_cert != '') {?>
       <span class="uploadGLI1"  id="uploadGLI1">
	   <a class="GLI1" style="display:none;" href="javascript:doc_upload('1','GLI','<?PHP echo $GLI_data[0]->id; ?>');" id="update_compliance"></a></span>

<div class="GLI1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('GLI1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
      ...
      <?php  } else { ?>
            ...
            <span class="uploadGLI1"  id="uploadGLI1">
	<a class="GLI1" style="display:none;" href="javascript:doc_upload('1','GLI','<?PHP echo $GLI_data[0]->id; ?>');" id="update_compliance" ></a>
			</span>
			<div class="GLI1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('GLI1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
   ...
   <div class="1GLI">
   <a href="javascript:del_upld_cert('GLI_upld_cert1','<?PHP echo $GLI_data[0]->GLI_upld_cert; ?>','liability_insurence','GLI','<?PHP echo $GLI_data[0]->id; ?>','1')" class="edit_complaince" ></a>
   <br />  
	<a href="javascript:cleardocument('GLI','<?PHP echo $GLI_data[0]->id; ?>','1')" class="clear_complaince" ></a>
   <?php if(count($GLI_data) == 1){ ?>
<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_GLI();"></a>
<?php } ?>
  </div>
...
document.getElementById(field+id).value = data;
    ...
    <div class="lic-pan-left">
      ...
      <div class="rmv" style="padding:0px;"><?PHP if($GLI_data[$k]->GLI_upld_cert != '') {?>
			  ...
			  <a class="GLI<?PHP echo $k+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $k+1; ?>,'GLI','<?PHP echo $GLI_data[$k]->id; ?>');" id="update_compliance"></a></span> 
			  <div class="GLI<?PHP echo $k+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('GLI<?PHP echo $k+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div><span class="uploadGLI<?PHP echo $k+1; ?>"  id="uploadGLI<?PHP echo $k+1; ?>" style="width:160px; left:-6px; display: none;">
<a href="javascript:doc_upload(<?PHP echo $k+1; ?>,'GLI','<?PHP echo $GLI_data[$k]->id; ?>');" id="upload_compliance"></a></span>
          
      <?php  } else { ?>
            <span class="uploadGLI<?PHP echo $k+1; ?>"  id="uploadGLI<?PHP echo $k+1; ?>" style="width:160px; left:-6px;">
			<a class="GLI<?PHP echo $k+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $k+1; ?>,'GLI','<?PHP echo $GLI_data[$k]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove<?PHP echo $k+1; ?>"  style="width:160px; left:-6px;">
	   <a href="javascript:del_upld_cert('GLI_upld_cert<?PHP echo $k+1; ?>','<?PHP echo $GLI_data[$k]->GLI_upld_cert; ?>','liability_insurence','GLI','<?PHP echo $GLI_data[$k]->id; ?>','<?PHP echo $k+1; ?>')" class="edit_complaince" >
       </a></span>
...
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
   ...
   <div class="<?PHP echo $k+1; ?>GLI" id="savedocs_vendor_before">
   <a href="javascript:del_upld_cert('GLI_upld_cert1','capture4.PNG','liability_insurence','GLI','1075',<?PHP echo $k+1; ?>)" class="edit_complaince"></a>
   <br /><a href="javascript:del_callajaxcomp_GLI('liability_insurence','<?php echo $GLI_data[$k]->id;?>','<?PHP echo $k+1; ?>');" class="delete_complaince"></a>
        ...
        <div class="in-pan1"  style="margin-top:-20px;">
          <label></label>
		   <?php
			...
			?>
         <table cellpadding="0" cellspacing="0" style="pointer-events: none;" class="GLI<?php echo $k+1; ?>_pointers"><tr height="8"></tr><tr><td>
...
<div class="lic-pan">
    ...
    <div class="lic-pan-left">
      ...
      <div class="rmv" style="padding:0px;"><?PHP if($AIP_data[0]->aip_upld_cert != '') {?>
            <span class="uploadaip1"  id="uploadaip1" style="width:160px; left:-6px;">
			<a class="aip1" style="display:none;" href="javascript:doc_upload('1','aip','<?PHP echo $AIP_data[0]->id; ?>');" id="update_compliance"></a></span>
<div class="aip1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('AIP1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
      <?php  } else { ?>
             <span class="uploadaip1"  id="uploadaip1" style="width:160px; left:-6px;"><a class="aip1" style="display:none;" href="javascript:doc_upload('1','aip','<?PHP echo $AIP_data[0]->id; ?>');" id="upload_compliance"></a></span>
...
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
  ...
  <div class="1aip" id="savedocs_vendor_before">
   <a href="javascript:del_upld_cert('aip_upld_cert1','<?PHP echo $AIP_data[0]->aip_upld_cert; ?>','vendor_auto_insurance','aip','<?PHP echo $AIP_data[0]->id; ?>','1')" class="edit_complaince" ></a>
   <br />  
	<a href="javascript:cleardocument('aip','<?PHP echo $AIP_data[0]->id; ?>','1')" class="clear_complaince" ></a> 
   <?php if(count($AIP_data) == 1){ ?>
   <br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_AIP();"></a>
   <?php } ?>
    ...
    <div class="lic-pan-left">
      ...
      <?php } ?>
       <div class="rmv" style="padding:0px;"><?PHP if($AIP_data[$mj]->aip_upld_cert != '') {?>
             <span class="uploadaip<?PHP echo $mj+1; ?>"  id="uploadaip<?PHP echo $mj+1; ?>" style="width:160px; left:-6px;">
			 <a class="aip<?PHP echo $mj+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $mj+1; ?>,'aip','<?PHP echo $AIP_data[$mj]->id; ?>');" id="update_compliance"></a></span>
<div class="aip<?PHP echo $mj+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('AIP<?PHP echo $mj+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
      <?php  } else { ?>
	   ...
	   <span class="remove<?PHP echo $mj+1; ?>"  id="removeaip<?PHP echo $mj+1; ?>" style="display: none;">
	   <a href="javascript:del_upld_cert('aip_upld_cert1','<?PHP echo $AIP_data[$mj]->aip_upld_cert; ?>','vendor_auto_insurance','aip','<?PHP echo $AIP_data[$mj]->id; ?>','<?PHP echo $mj+1; ?>')" class="edit_complaince"></a></span>
	   
<div class="aip<?PHP echo $mj+1; ?>" id="savedocs_vendor" style="display:none;">
<a href="javascript: Alt_saveassubmit('AIP<?PHP echo $mj+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
   ...
   <a href="javascript:del_upld_cert('aip_upld_cert<?PHP echo $mj+1; ?>','<?PHP echo $AIP_data[$mj]->aip_upld_cert; ?>','vendor_auto_insurance','aip','<?PHP echo $AIP_data[$mj]->id; ?>','<?PHP echo $mj+1; ?>')" class="edit_complaince"></a>
   <a href="javascript:del_callajaxcomp_AIP('auto_insurance','<?php echo $AIP_data[$mj]->id;?>','<?PHP echo $mj+1; ?>');" class="delete_complaince"></a>
   <?php if( count($AIP_data) == $mj+1 ){ ?>
   <a class="addanotherbutton_vendor" href="javascript:callajaxcomp_AIP();"></a>
   <?php } ?>
   </span>
      </div>
...
<div class="lic-pan">
    ...
    <?php if($WCI_data[0]->WCI_upld_cert!='') { ?>
     ...
     <div class="rmv" style="padding:0px;"><?PHP if($WCI_data[0]->WCI_upld_cert != '') {?>
           <span class="uploadWCI1"  id="uploadWCI1">
 <a class="WCI1" style="display:none;" href="javascript:doc_upload('1','WCI','<?PHP echo $WCI_data[0]->id; ?>');" id="update_compliance"></a></span>
      <?php  } else { ?>
          <span class="uploadWCI1"  id="uploadWCI1"><a class="WCI1" style="display:none;" href="javascript:doc_upload('1','WCI','<?PHP echo $WCI_data[0]->id; ?>');" id="update_compliance"></a></span>
       <span class="remove1"><a href="javascript:del_upld_cert('WCI_upld_cert1','<?PHP echo $WCI_data[0]->WCI_upld_cert; ?>','workers_companies_insurance','WCI','<?PHP echo $WCI_data[0]->id; ?>','1')" class="upload_compliance" >
       </a></span>
     
   <?php } ?><input type="hidden" class="file_input_textbox" name="WCI_upld_cert1" id="WCI_upld_cert1"  value="<?PHP echo $WCI_data[0]->WCI_upld_cert; ?>" />
<div class="1WCI">
<span class="remove1"><a href="javascript:del_upld_cert('WCI_upld_cert1','<?PHP echo $WCI_data[0]->WCI_upld_cert; ?>','workers_companies_insurance','WCI','<?PHP echo $WCI_data[0]->id; ?>','1')" class="edit_complaince" style="display:none;" ></a></span>
</div>
<div class="WCI1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('WCI1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
</div>
	<div class="1WCI">
   <a href="javascript:del_upld_cert('WCI_upld_cert1','<?PHP echo $WCI_data[0]->WCI_upld_cert; ?>','workers_companies_insurance','WCI','<?PHP echo $WCI_data[0]->id; ?>','1')" class="edit_complaince" ></a>
	<br />  
	<a href="javascript:cleardocument('WCI','<?PHP echo $WCI_data[0]->id; ?>','1')" class="clear_complaince"></a>    
	   <?php if(count($WCI_data) == 1){ ?>
<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_WCI();"></a>
<?php } ?>	   
  </div>
...
?>
 ...
 <span class="uploadWCI<?PHP echo $m+1; ?>"  id="uploadWCI<?PHP echo $m+1; ?>" style="width:160px; left:-6px;"><a class="WCI<?PHP echo $m+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $m+1; ?>,'WCI','<?PHP echo $WCI_data[$m]->id; ?>');" id="update_compliance"></a></span>
<div class="WCI<?PHP echo $m+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('WCI<?PHP echo $m+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
...
<span class="remove<?PHP echo $m+1; ?>" id="removeWCI<?PHP echo $m+1; ?>">
<a href="javascript:del_upld_cert('WCI_upld_cert<?PHP echo $m+1; ?>','<?PHP echo $WCI_data[$m]->WCI_upld_cert; ?>','workers_companies_insurance','WCI','<?PHP echo $WCI_data[$m]->id; ?>','<?PHP echo $m+1; ?>')" class="edit_complaince"></a>
	   <a href="javascript:del_callajaxcomp_WCI('workers_companies_insurance','<?php echo $WCI_data[$m]->id;?>','<?PHP echo $m+1; ?>');" class="delete_complaince"></a>
	   <?php if( count($WCI_data) == $m+1 ){ ?>
	   <a class="addanotherbutton_vendor" href="javascript:callajaxcomp_WCI();"></a>
	   <?php } ?>
...
<!--<script type="text/javascript">G('#OLN_expdate1').datepicker({dateFormat: 'mm-dd-yy', changeYear: true,maxDate: "+5y",changeMonth:true});</script>-->
  <div  id="line_task_UMB<?PHP echo 1; ?>"><div class="lic-pan">
    ...
    <div class="lic-pan-left">
      ...
      <?php } ?>
      <div class="rmv" style="padding:0px;"><?PHP if($UMB_data[0]->UMB_upld_cert != '') { ?> <span class="upload1"  id="uploadUMB1" style="width:160px; left:-6px;"><a style="display:none;" class="UMB1" href="javascript:doc_upload('1','UMB','<?PHP echo $UMB_data[0]->id; ?>');" id="update_compliance"></a></span>
	  <div style="display:none;" class="UMB1" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('UMB1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
      <?php  } else { ?>
           <span class="upload1"  id="uploadUMB1"><a style="display:none;" class="UMB1" href="javascript:doc_upload('1','UMB','<?PHP echo $UMB_data[0]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove1"><a href="javascript:del_upld_cert('UMB_upld_cert1','<?PHP echo $UMB_data[0]->UMB_upld_cert; ?>','occupational_license','UMB','<?PHP echo $UMB_data[0]->id; ?>','1')">
...
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
   ...
   <div class="1UMB">
   <a href="javascript:del_upld_cert('UMB_upld_cert1','<?PHP echo $UMB_data[0]->UMB_upld_cert; ?>','occupational_license','UMB','<?PHP echo $UMB_data[0]->id; ?>','1')" class="edit_complaince"></a>
	<br />  
	<a href="javascript:cleardocument('UMB','<?PHP echo $UMB_data[0]->id; ?>','1')" class="clear_complaince" ></a>   
<?php if( count($UMB_data) == 1 ){ ?>
<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_UMB();"></a>  
<?php } ?>
  </div>
...
<div class="lic-pan">
    ...
    <div class="lic-pan-left">
	  ...
	  <a style="display:none;" class="UMB<?PHP echo $i+1; ?>" href="javascript:doc_upload('<?PHP echo $i+1; ?>','UMB','<?PHP echo $UMB_data[$i]->id; ?>');" id="update_compliance"></a></span>
      <div style="display:none;" class="UMB<?PHP echo $i+1; ?>" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('UMB<?PHP echo $i+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>   
      <?php  } else { ?>
       ...
       <span class="remove<?PHP echo $i+1; ?>"  style="width:160px; left:-6px;">
<a href="javascript:del_upld_cert('UMB_upld_cert<?PHP echo $i+1; ?>','<?PHP echo $UMB_data[$i]->UMB_upld_cert; ?>','occupational_license','UMB','<?PHP echo $UMB_data[$i]->id; ?>','<?PHP echo $i+1; ?>')" class="upload_compliance" id="removeUMB<?PHP echo $i+1; ?>">
       </a></span>
...
<a href="javascript:cenceleditdocs();"><img src="components/com_camassistant/assets/images/CancelButton.gif"></a>
   ...
   <?php } ?>  <input type="hidden" class="file_input_textbox" name="UMB_upld_cert[]" id="UMB_upld_cert<?PHP echo $i+1; ?>"  value="<?PHP echo $UMB_data[$i]->UMB_upld_cert; ?>" />
	  ...
	  <div id="UMB_delete_<?PHP echo $i+1; ?>" class="<?PHP echo $i+1; ?>UMB">
<span class="remove2">
<a href="javascript:del_upld_cert('UMB_upld_cert<?PHP echo $i+1; ?>','<?PHP echo $UMB_data[$i]->UMB_upld_cert; ?>','occupational_license','UMB','<?PHP echo $UMB_data[$i]->id; ?>','<?PHP echo $i+1; ?>')" class="edit_complaince" id="removeUMB<?PHP echo $i+1; ?>"></a>
	  <a href="javascript:del_callajaxcomp_UMB('umbrella_license','<?php echo $UMB_data[$i]->id;?>','<?PHP echo $i+1; ?>');" class="delete_complaince"></a>
<?php if( count($UMB_data) == $i+1 ){ ?>	   
 <a class="addanotherbutton_vendor" href="javascript:callajaxcomp_UMB();"></a>
 <?php } ?>
...
<div class="lic-pan">
    ...
    <?php if($OMI_data[0]->OMI_upld_cert!='') { ?>
     ...
     <div class="rmv" style="padding:0px;"><?PHP if($OMI_data[0]->OMI_upld_cert != '') {?>
           <span class="uploadOMI1"  id="uploadOMI1">
		   <a class="OMI1" style="display:none;" href="javascript:doc_upload('1','OMI','<?PHP echo $OMI_data[0]->id; ?>');" id="update_compliance"></a></span>
         
      <?php  } else { ?>
          <span class="uploadOMI1"  id="uploadOMI1"><a class="OMI1" style="display:none;" href="javascript:doc_upload('1','OMI','<?PHP echo $OMI_data[0]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove1"  style="display:none;"><a href="javascript:del_upld_cert('OMI_upld_cert1','<?PHP echo $OMI_data[0]->OMI_upld_cert; ?>','omissions_companies_insurance','OMI','<?PHP echo $OMI_data[0]->id; ?>','1')" class="edit_complaince" id="removeOMI1">
       </a></span>
     
   <?php } ?><input type="hidden" class="file_input_textbox" name="OMI_upld_cert1" id="OMI_upld_cert1"  value="<?PHP echo $OMI_data[0]->OMI_upld_cert; ?>" />
<div class="1OMI">
<span class="remove1"><a href="javascript:del_upld_cert('OMI_upld_cert1','<?PHP echo $OMI_data[0]->OMI_upld_cert; ?>','omissions_companies_insurance','OMI','<?PHP echo $OMI_data[0]->id; ?>','1')" class="edit_complaince" id="removeOMI1" style="display:none;"></a></span>
</div>
<div class="OMI1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OMI1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
</div>
	<div class="1OMI">
   <a href="javascript:del_upld_cert('OMI_upld_cert1','<?PHP echo $OMI_data[0]->OMI_upld_cert; ?>','omissions_companies_insurance','OMI','<?PHP echo $OMI_data[0]->id; ?>','1')" class="edit_complaince" id="removeOMI1">
       </a>
	<br />  
	<a href="javascript:cleardocument('OMI','<?PHP echo $OMI_data[0]->id; ?>','1')" class="clear_complaince" id="removeW91"></a>    
	   <?php if(count($OMI_data) == 1){ ?>
<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_OMI();"></a>
<?php } ?>	   
  </div>
...
?>
 ...
 <span class="uploadOMI<?PHP echo $m+1; ?>"  id="uploadOMI<?PHP echo $m+1; ?>" style="width:160px; left:-6px;"><a class="OMI<?PHP echo $m+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $m+1; ?>,'OMI','<?PHP echo $OMI_data[$m]->id; ?>');" id="update_compliance"></a></span>
<div class="OMI<?PHP echo $m+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OMI<?PHP echo $m+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>

      <?php  } else { ?>
             <span class="uploadOMI<?PHP echo $m+1; ?>"  id="uploadOMI<?PHP echo $m+1; ?>" style="width:160px; left:-6px;"><a class="OMI<?PHP echo $m+1; ?>" style="display:none;" href="javascript:doc_upload('<?PHP echo $m+1; ?>','OMI','<?PHP echo $OMI_data[$m]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove<?PHP echo $m+1; ?>"><a href="javascript:del_upld_cert('OMI_upld_cert<?PHP echo $m+1; ?>','<?PHP echo $OMI_data[$m]->OMI_upld_cert; ?>','omissions_companies_insurance','OMI','<?PHP echo $OMI_data[$m]->id; ?>','<?PHP echo $m+1; ?>')" class="delete_complaince" id="removeOMI<?PHP echo $m+1; ?>">
       </a></span>
<div class="OMI<?PHP echo $m+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OMI<?PHP echo $m+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
   ...
   <div class="<?php echo $m+1; ?>OMI" id="OMI_delete_<?php echo $m; ?>">
<span class="remove<?PHP echo $m+1; ?>">
<a href="javascript:del_upld_cert('OMI_upld_cert<?PHP echo $m+1; ?>','<?PHP echo $OMI_data[$m]->OMI_upld_cert; ?>','omissions_companies_insurance','OMI','<?PHP echo $OMI_data[$m]->id; ?>','<?PHP echo $m+1; ?>')" class="edit_complaince" id="removeOMI<?PHP echo $m+1; ?>">
       </a>
<a href="javascript:del_callajaxcomp_OMI('omissions_companies_insurance','<?php echo $OMI_data[$m]->id;?>','<?PHP echo $m+1; ?>');" class="delete_complaince"></a>
	   <?php if( count($OMI_data) == $m+1 ){ ?>
	 <a class="addanotherbutton_vendor" href="javascript:callajaxcomp_OMI();"></a>
	   <?php } ?>
...
<?php 
if($OMI_data[$m]->OMI_date_verified == '00-00-0000' && !$OMI_data[$m]->OMI_upld_cert) {
echo '<div class="verf"><div class="wse"><font color="gray">NONE</font></div></div>';
}
else{
	if( $user->subscribe_type == 'free' ){ ?>
...
<!--<script type="text/javascript">G('#OLN_expdate1').datepicker({dateFormat: 'mm-dd-yy', changeYear: true,maxDate: "+5y",changeMonth:true});</script>-->
  <div  id="line_task_OLN<?PHP echo 1; ?>"><div class="lic-pan">
    ...
    <div class="lic-pan-left">
      ...
      <?php } ?>
      <div class="rmv" style="padding:0px;"><?PHP if($OLN_data[0]->OLN_upld_cert != '') { ?> 
	  <span class="upload1"  id="uploadOLN1">
<a style="display:none;" class="OLN1" href="javascript:doc_upload('1','OLN','<?PHP echo $OLN_data[0]->id; ?>');" id="update_compliance"></a></span>
<div style="display:none;" class="OLN1" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OLN1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
      <?php  } else { ?>
           <span class="upload1"  id="uploadOLN1">
<a style="display:none;" class="OLN1" href="javascript:doc_upload('1','OLN','<?PHP echo $OLN_data[0]->id; ?>');" id="upload_compliance" ></a></span>
       <span class="remove1">
<a href="javascript:del_upld_cert('OLN_upld_cert1','<?PHP echo $OLN_data[0]->OLN_upld_cert; ?>','occupational_license','OLN','<?PHP echo $OLN_data[0]->id; ?>','1')" class="update_compliance" id="removeOLN1"></a></span>
<div style="display:none;" class="OLN1" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OLN1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
   ...
   <div class="1OLN">
   <a href="javascript:del_upld_cert('OLN_upld_cert1','<?PHP echo $OLN_data[0]->OLN_upld_cert; ?>','occupational_license','OLN','<?PHP echo $OLN_data[0]->id; ?>','1')" class="edit_complaince" id="removeOLN1">
       </a>
	<br />  
	<a href="javascript:cleardocument('OLN','<?PHP echo $OLN_data[0]->id; ?>','1')" class="clear_complaince"></a>
	      
<?php if( count($OLN_data) == 1 ){ ?>
<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_OLN();"></a>  
<?php } ?>
  </div>
       </div>
...
<div class="lic-pan">
    ...
    <div class="lic-pan-left">
	  ...
	  <a style="display:none;" class="OLN<?PHP echo $i+1; ?>" href="javascript:doc_upload('<?PHP echo $i+1; ?>','OLN','<?PHP echo $OLN_data[$i]->id; ?>');" id="update_compliance"></a></span>
<div style="display:none;" class="OLN<?PHP echo $i+1; ?>" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OLN<?PHP echo $i+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>         
      <?php  } else { ?>
            <span class="upload<?PHP echo $i+1; ?>"  id="uploadOLN<?PHP echo $i+1; ?>"><a style="display:none;" class="OLN<?PHP echo $i+1; ?>" href="#" onClick="javascript:doc_upload('<?PHP echo $i+1; ?>','OLN','<?PHP echo $OLN_data[$i]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove<?PHP echo $i+1; ?>">
	   <a href="javascript:del_upld_cert('OLN_upld_cert<?PHP echo $i+1; ?>','<?PHP echo $OLN_data[$i]->OLN_upld_cert; ?>','occupational_license','OLN','<?PHP echo $OLN_data[$i]->id; ?>','<?PHP echo $i+1; ?>')" class="edit_complaince" id="removeOLN<?PHP echo $i+1; ?>" style="display:none;"></a></span>
<div style="display:none;" class="OLN<?PHP echo $i+1; ?>" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('OLN<?PHP echo $i+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
   ...
   <?php } ?>  <input type="hidden" class="file_input_textbox" name="OLN_upld_cert[]" id="OLN_upld_cert<?PHP echo $i+1; ?>"  value="<?PHP echo $OLN_data[$i]->OLN_upld_cert; ?>" />
	  ...
	  <div id="OLN_delete_<?PHP echo $i+1; ?>" class="<?PHP echo $i+1; ?>OLN">
<span class="remove2">
<a href="javascript:del_upld_cert('OLN_upld_cert<?PHP echo $i+1; ?>','<?PHP echo $OLN_data[$i]->OLN_upld_cert; ?>','occupational_license','OLN','<?PHP echo $OLN_data[$i]->id; ?>','<?PHP echo $i+1; ?>')" class="edit_complaince" id="removeOLN<?PHP echo $i+1; ?>">
       </a>
	  <a  href="javascript:del_callajaxcomp_OLN('occupational_license','<?php echo $OLN_data[$i]->id;?>','<?PHP echo $i+1; ?>');" class="delete_complaince"></a>
<?php if( count($OLN_data) == $i+1 ){ ?>	   
 <a class="addanotherbutton_vendor" href="javascript:callajaxcomp_OLN();"></a>
 <?php } ?>
...
<?php //echo '<pre>'; print_r($PLN_data[0]);?>
    ...
    <div class="lic-pan-left">
     ...
     <div class="rmv"><?PHP if($PLN_data[0]->PLN_upld_cert != '') {?>
          <span class="uploadPLN1"  id="uploadPLN1">
		  <a class="PLN1" style="display:none;" href="javascript:doc_upload('1','PLN','<?PHP echo $PLN_data[0]->id; ?>');" id="update_compliance"></a></span>
<div class="PLN1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('PLN1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
         
      <?php  } else { ?>
         <span class="upload1"  id="uploadPLN1" style="width:160px; left:-6px;"><a class="PLN1" style="display:none;" href="javascript:doc_upload('1','PLN','<?PHP echo $PLN_data[0]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove1">
	   <a href="javascript:del_upld_cert('PLN_upld_cert1','<?PHP echo $PLN_data[0]->PLN_upld_cert; ?>','professional_license','PLN','<?PHP echo $PLN_data[0]->id; ?>','1')" style="display:none;" class="edit_complaince" id="removePLN1"></a></span>
<div class="PLN1" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('PLN1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
   ...
   <div class="1PLN">
   <a href="javascript:del_upld_cert('PLN_upld_cert1','<?PHP echo $PLN_data[0]->PLN_upld_cert; ?>','professional_license','PLN','<?PHP echo $PLN_data[0]->id; ?>','1')" class="edit_complaince"></a>
	<br />  
	<a href="javascript:cleardocument('PLN','<?PHP echo $PLN_data[0]->id; ?>','1')" class="clear_complaince" id="removeW91"></a>   
	   <?php if( count($PLN_data) == 1 ){ ?> 
	<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_PLN();"></a>	   
	<?php } ?>
  </div>
        </div>
   ...
   <input type="hidden" value="" name="PLN_editready" id="PLN_idedit<?PHP echo $j+1; ?>" />
    ...
    <div class="lic-pan-left">
     ...
     <div class="rmv" style="padding:0px;"><?PHP if($PLN_data[$j]->PLN_upld_cert != '') {?>
		  ...
		  <a class="PLN<?PHP echo $j+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $j+1; ?>,'PLN','<?PHP echo $PLN_data[$j]->id; ?>');" id="update_compliance"></a></span>
<div class="PLN<?PHP echo $j+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('PLN<?PHP echo $j+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
         
      <?php  } else { ?>
            <span class="upload<?PHP echo $j+1; ?>"  id="uploadPLN<?PHP echo $j+1; ?>" style="width:160px; left:-6px;"><a class="PLN<?PHP echo $j+1; ?>" style="display:none;" href="#" onClick="javascript:doc_upload(<?PHP echo $j+1; ?>,'PLN','<?PHP echo $PLN_data[$j]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove<?PHP echo $j+1; ?>">
	   <a href="javascript:del_upld_cert('PLN_upld_cert<?PHP echo $j+1; ?>','<?PHP echo $PLN_data[$j]->PLN_upld_cert; ?>','professional_license','PLN','<?PHP echo $PLN_data[$j]->id; ?>','<?PHP echo $j+1; ?>')" class="edit_complaince" id="removePLN<?PHP echo $j+1; ?>">
       </a></span>
<div class="PLN<?PHP echo $j+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('PLN<?PHP echo $j+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
...
<span class="remove<?PHP echo $j+1; ?>">
<a href="javascript:del_upld_cert('PLN_upld_cert<?PHP echo $j+1; ?>','<?PHP echo $PLN_data[$j]->PLN_upld_cert; ?>','professional_license','PLN','<?PHP echo $PLN_data[$j]->id; ?>','<?PHP echo $j+1; ?>')" class="edit_complaince" id="removePLN<?PHP echo $j+1; ?>"></a>
<a href="javascript:del_callajaxcomp_PLN('professional_license','<?php echo $PLN_data[$j]->id;?>','<?PHP echo $j+1; ?>');" class="delete_complaince"></a>
	   <?php if( count($PLN_data) == $j+1 ){ ?>
<a class="addanotherbutton_vendor" href="javascript:callajaxcomp_PLN();"></a> 
<?php } ?>
...
<a style="display:none;" class="wc1" href="javascript:doc_upload('1','wc','<?PHP echo $WC_data[0]->id; ?>');" id="update_compliance"></a></span>
<div style="display:none;" class="wc1" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('WC1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
          
      <?php  } else { ?>

             <span class="uploadwc1"  id="uploadwc1">
			 <a style="display:none;" class="wc1" href="javascript:doc_upload('1','wc','<?PHP echo $WC_data[0]->id; ?>');" id="upload_compliance"></a></span>
       <span id="removewc1" class="remove1">
	   <a href="javascript:del_upld_cert('wc_upld_cert1','<?PHP echo $WC_data[0]->wc_upld_cert; ?>','workers_compansation','wc','<?PHP echo $WC_data[0]->id; ?>','1')" class="edit_complaince" id="removewc1" style="display:none;">
       </a></span>
<div style="display:none;" class="wc1" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('WC1');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
   ...
   <div class="1wc">
   <a href="javascript:del_upld_cert('wc_upld_cert1','<?PHP echo $WC_data[0]->wc_upld_cert; ?>','workers_compansation','wc','<?PHP echo $WC_data[0]->id; ?>','1')" class="edit_complaince" id="removewc1"></a>
	<br />  
	<a href="javascript:cleardocument('wc','<?PHP echo $WC_data[0]->id; ?>','1')" class="clear_complaince" id="removeW91"></a>	   
	   <?php if( count($WC_data) == 1 ){ ?>
<br /><a class="addanotherbutton_vendor" href="javascript:callajaxcomp_WC();"></a>	   
<?php } ?>
  </div>
       </div>
    ...
    <div class="lic-pan-left">
      ...
      <?php } ?>
       <div class="rmv" style="padding:0px;"><?PHP if($WC_data[$mj]->wc_upld_cert != '') {?>
             <span class="uploadwc<?PHP echo $mj+1; ?>"  id="uploadwc<?PHP echo $mj+1; ?>">
			 <a class="wc<?PHP echo $mj+1; ?>" style="display:none;" href="javascript:doc_upload(<?PHP echo $mj+1; ?>,'wc','<?PHP echo $WC_data[$mj]->id; ?>');" id="update_compliance"></a></span>
			 <div class="wc<?PHP echo $mj+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('WC<?PHP echo $mj+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
      <?php  } else { ?>
            <span class="uploadwc<?PHP echo $mj+1; ?>"  id="uploadwc<?PHP echo $mj+1; ?>">
			<a class="wc<?PHP echo $mj+1; ?>" style="display:none;" href="javascript:doc_upload('<?PHP echo $mj+1; ?>','wc','<?PHP echo $WC_data[$mj]->id; ?>');" id="upload_compliance"></a></span>
       <span class="remove<?PHP echo $mj+1; ?>"  id="removewc<?PHP echo $mj+1; ?>" style="display: none;">
<a href="javascript:del_upld_cert('wc_upld_cert1','<?PHP echo $WC_data[$mj]->wc_upld_cert; ?>','workers_compansation','wc','<?PHP echo $WC_data[$mj]->id; ?>','<?PHP echo $mj+1; ?>')" class="edit_complaince" id="removewc<?PHP echo $mj+1; ?>" style="display:none;"></a></span>
<div class="wc<?PHP echo $mj+1; ?>" style="display:none;" id="savedocs_vendor">
<a href="javascript: Alt_saveassubmit('WC<?PHP echo $mj+1; ?>');" class="save_complaince"></a>
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a>
</div>
...
<span class="remove<?PHP echo $mj+1; ?>"><a href="javascript:del_upld_cert('wc_upld_cert1','<?PHP echo $WC_data[$mj]->wc_upld_cert; ?>','workers_compansation','wc','<?PHP echo $WC_data[$mj]->id; ?>','<?PHP echo $mj+1; ?>')" class="edit_complaince" id="removewc<?PHP echo $mj+1; ?>"></a>
<a href="javascript:del_callajaxcomp_WC('workers_compansation','<?php echo $WC_data[$mj]->id;?>','<?PHP echo $mj+1; ?>');" class="delete_complaince"></a>
<?php if( count($WC_data) == $mj+1 ){ ?>	
<a class="addanotherbutton_vendor" href="javascript:callajaxcomp_WC();"></a>
<?php } ?>
