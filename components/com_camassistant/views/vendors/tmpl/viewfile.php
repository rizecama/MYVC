...
<div style="margin: 4px 0px 0px -3px; text-align: center;" class="2GLI">
   ...
   <a style="background:none" class="viewbuttons" href="index.php?option=com_camassistant&controller=vendors&task=openmarketdocs&filename=<?php echo $_REQUEST['file']; ?>&vendorid=<?php echo $vendorid; ?>">DOWNLOAD</a>
  </div>
