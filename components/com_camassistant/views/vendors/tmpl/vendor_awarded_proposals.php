...
// no direct access
	...
	$tpages = $this->getAliasNbPages();
		...
		$this->SetFontSize(7);
		$this->Cell(0, 5, 'Copyright 2012-2016 HOA Assistant, LLC', 0, 0, 'C');
	}
	...
	$altproposals_submitted="SELECT count(*) FROM #__cam_vendor_proposals where rfpno='".$RFP_info->id."' AND Alt_bid='yes'";
...
';
  ...
  <tr><td><img src="templates/camassistant_left/images/line_hori.jpg" /></td></tr>
  <tr style="border-top:2px solid green;">
    <td><p style="font-size:31px; color:#85c440; font-weight:bold; padding:95px 0px 15px 0px; margin:0px;"><br /><br />ABOUT THIS REPORT</p></td>
  </tr>
  <tr>
...
align="center" valign="middle" bgcolor="#f3f9e8" height="52px" style="border:0.5px solid #b7b7b7; font-family:ArialBlack;"><span style="font-size:16pt;">&#160;</span><div style="font-size:24px;  color:#000; font-weight:bold;">Vendor Address:</div></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px;"><p style="font-size:24px;  color:#000; font-weight:bold;">Contact Name:</p></td></tr><tr><td align="center" valign="middle" bgcolor="#f3f9e8" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px;"><p style="font-size:24px;  color:#000; font-weight:bold;">Office Number:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7;  font-family:ArialBlack; height:15px; "><p style="font-size:24px;  color:#000; font-weight:bold;">Alt.Number:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px; " bgcolor="#f3f9e8"><p style="font-size:24px; 
 color:#000; font-weight:bold;">Mobile 
Number:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:36px;"><p style="font-size:24px; color:#000; font-weight:bold;"><br/>Email Address:</p></td></tr><tr><td align="center" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px;"><p style="font-size:24px; color:#000; font-weight:bold;">Business Established:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px; "><p style="font-size:24px; font-weight:bold; color:#000;">General Liability:</p></td></tr><tr><td align="center" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:22px;"><table cellpadding="3" cellspacing="1"><tr><td style="font-size:24px; font-family:Arial Black; color:#000; font-weight:bold;"><font style="font-size:28px;" valign="middle"> </font>Workers Comp. Policy?</td></tr></table></td></tr><tr><td align="center" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:16px;"><p style="font-size:24px; color:#000; font-weight:bold;">Meets Compliance Standards?</p></td></tr>
<tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; height:45px;"><p><font style="font-size:24px; font-family:ArialBlack; color:#000;font-weight:bold;">In-House Vendor?</font><br/><font style="font-size:25px;color:#000;">(Vendor affiliated with management company)</font></p></td></tr><tr><td align="center" valign="middle" bgcolor="gray" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:26px;"><table cellpadding="4" cellspacing="2"><tr><td style="font-size:21px; font-family:Arial Black; color:#fff; font-weight:bold;"><font style="font-size:24px;"> </font>TOTAL AMOUNT PROPOSED:</td></tr></table></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:16px;"><p style="font-size:24px; color:#000; font-weight:bold;">Alternate Proposal?</p></td></tr></table></td>';
							 // $cnt=count($BID_Vendors_info);
							  if($cnt>0)
							  {
	...
	//echo $image; exit;
		$rateimage= JURI::root().DS.'components'.DS.'com_camassistant'.DS.'assets'.DS.'images'.DS.'rating'.DS;
			...
			<img src="'.$rate_image.'" /><br/>'.$rating .' Out of 5</td></tr>
							<tr><td height="52" valign="middle" bgcolor="#f3f9e8" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; "><font size="9">&#160; <br /></font>'.$BID_Vendors_info[$v]->company_address.',<br />'.$BID_Vendors_info[$v]->city.',<br />'.$vstate.' '.$BID_Vendors_info[$v]->zipcode.'</td>  </tr><tr><td height="15" style="font-size:24px ;text-align: center; border:0.5px solid #b7b7b7; ">'.$primarycontactperson.'</td></tr>';


						$htmlcontent .= '<tr><td valign="middle" height="15" bgcolor="#f3f9e8" style="font-size:24px; text-align: center; border:0.5px solid #b7b7b7; ">'. $BID_Vendors_info[$v]->company_phone.'</td></tr>';


							$htmlcontent .= '<tr><td valign="middle" height="15" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; ">'.$BID_Vendors_info[$v]->alt_phone.'</td>  </tr>';

			 $htmlcontent .= '<tr><td height="15" valign="middle" bgcolor="#f3f9e8" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; ">'.$BID_Vendors_info[$v]->cellphone.'</td></tr><tr><td height="36" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; "><br/><br/>'.$clearemail.'</td></tr><tr><td height="15" bgcolor="#f3f9e8" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center;">'.$BID_Vendors_info[$v]->established_year.'</td></tr>';
...
//Completed
		  ...
		  $htmlcontent .= '<tr><td height="26" valign="middle" bgcolor="#21314d" style="'.$class.'; border:0.5px solid #b7b7b7; font-size:42px; font-weight:bold; font-family:ArialBlack; color:#fff;"><font style="font-size:48px;"> </font>$'.$BID_Vendors_info[$v]->proposal_total_price.'<font style="font-size:36px;"> </font></td></tr>';
			...
			$htmlcontent .= '<tr><td height="16" valign="middle" style="font-size:30px; border:0.5px solid #b7b7b7; font-weight:bold; text-align: center; color:#000; font-family:ArialBlack;">'.$Alt_Price.'</td>
		  </tr>';
  ...
  $line_cnt=count($RFP_NOTES_summary);
                        ...
                        for($li=0; $li<$line_cnt; $li++)
                        {
                                    //echo '<pre>'; print_r($RFP_NOTES_summary[$li]);
                                        ...
                                        {
									  	//echo '<pre>'; print_r($RFP_NOTES_summary[$li]);
                        $lineitemprice .= ' <tr> <td align="center" height="50" valign="middle" style="border:0.5px solid #b7b7b7;"><br/><font style="font-size:24px;  font-family:Arial; font-weight:bold; color:#000;">Line Item #'.($li+1).' Pricing:</font> <font style="font-size:24px; font-family:Arial;">'.$RFP_NOTES_summary[$li]->linetaskname.'</font></td></tr>';
 ...
 <tr> <td align="center" valign="middle" bgcolor="#7ab800" style="border:0.5px solid #b7b7b7; height:15px;"><p style="font-size:24px; color:#FFF; font-weight:bold;">VENDOR'.($v+1).'</p></td></tr>
  ...
  $cnt_prices=count($TASKS_summary);
								 ...
								 for($TP=0; $TP<$cnt_prices; $TP++)
								 {
								  ...
								  //echo $BID_Vendors_info[$v]->proposedvendorid;
...
//echo '<pre>'; print_r($star_final);
		...
		$lineitems_prices="SELECT item_price FROM #__cam_rfpsow_docs_lineitems_prices where vendor_id='".$BID_Vendors_info[$v]->proposedvendorid."' and item_id=".$TASKS_summary[$TP]->task_id;
							...
							//echo '<pre>'; print_r($lineitemsprices);
									...
									if($cnt_Task_Prices == 0 || !$lineitemsprices)
									{
									echo $TASKS_summary[$TP]->task_id;
											$lineitemprice .= '<tr><td align="center" valign="middle" height="50" style="border:0.5px solid #b7b7b7; font-size:35px; font-family:Arial Black; color:#000; font-weight:bold;"><br/><br/>Included In Total Price</td></tr>';
											//exit;
									} else {
...
$lineitemprice .= '<tr><td align="center" valign="middle" height="50" style="border:0.5px solid #b7b7b7; font-size:35px; font-family:Arial Black; color:#000; font-weight:bold;"><br/><br/>$'.$lineitemsprices1.''.$as.'</td></tr>';
									
//echo $cnt_Task_Prices.'<br />'.$BID_Vendors_info[$v]->proposedvendorid.'<br /><br />';
									 /*for($B=0; $B<$cnt_Task_Prices; $B++)
									 {
...
$html_notes = str_replace('?','.', $html_notes);														
							 $htmlcontent3 ='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:40px"><tr><td colspan="2"><table width="550px" cellspacing="0" cellpadding="0" valign="middle"><tr><td width="100%" height="15" style="font-size:32px; text-align: left; vertical-align:middile; color:#000; font-weight:bold;" valign="middle">LINE ITEM #'.$lid.': <font style="font-size:24px;">'.$RFP_NOTES_summary[$li]->linetaskname.'.</font></td></tr></table></td></tr><tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$html_notes.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">File(s) Provided to Vendors: ';
...
//exit;
			// $default = 'http://camassistant.com/dev/components/com_camassistant/doc/';
			...
			// $htmlcontent3 .= '<a href="http://camassistant.com/dev/index.php?option=com_camassistant&controller=popupdocs&task=open&title='.$RFP_NOTES_summary[$li]->taskuploads.'&path='.$file_link.'"> '.$RFP_NOTES_summary[$li]->taskuploads.'</a>';
			 } else {
			 $htmlcontent3 .= 'None';
			 }
           ...
           $htmlcontent3 .=  $EXCEPTION;
				...
				/*$cnt_prices=count($TASKS_summary);
					if($cnt_prices>0)
							...
							$htmlcontent3 .='</td></tr><tr style="font-size:11px;"><td></td></tr>';
							$htmlcontent3 .= '</table>';
...
//echo '<pre>';print_r(array_unique($other_price_s));
		...
		$vendor_comp_name = $db->loadResult();
							$htmlcontentotherprice .=  '<tr><td bgcolor="'.$class.'" style="color:#ffffff; font-color:#ffffff; font-weight:bold; font-family:ArialBlack; font-size:30px; height:15px; border:1px solid gray; text-align: left;" width="40%">VENDOR '.$vendor_comp_name.':</td><td width="20%" style="text-align: left;"  style="border:1px solid gray; color:gray; font-size:30px; font-weight:bold;">$ '.$other_price_d.' </td></tr>';
							 }
							}
...
//echo '<pre>'; print_r($RFP_info->work_perform);
		...
		/**** sof table pan****/
			$htmlcontent .= '<tr><td width="140" align="left"><table width="100%" border="0" cellspacing="2" cellpadding="2"><tr><td align="center" bgcolor="gray" style="border:0.5px solid #b7b7b7;" height="14"><p style="font-size:24px;  color:#FFF; font-weight:bold;">DESCRIPTION</p></td></tr> <tr><td align="center" style="border:0.5px solid #b7b7b7;  font-family:ArialBlack; height:60px;"><p style="font-size:24px;color:#000; font-weight:bold;"><br/><br/></p></td></tr><tr><td align="center" valign="middle" bgcolor="#f3f9e8" style="border:0.5px solid #b7b7b7;  font-family:ArialBlack; height:36px;"><p style="font-size:24px;  color:#000; font-weight:bold;"><br>Company Name:</p></td></tr><tr><td align="center" valign="middle" height="48"><p><font style="font-size:24px;font-family:ArialBlack; color:#000; font-weight:bold;">Vendor Apple Rating:</font><br/><font style="font-size:24px;color:#000;">(Based on customer surveys & vendor follow through)</font></p></td></tr><tr valign="middle" cellpadding-top="20">
			<td align="center" valign="middle" bgcolor="#f3f9e8" height="52px" style="border:0.5px solid #b7b7b7; font-family:ArialBlack;"><span style="font-size:16pt;">&#160;</span><div style="font-size:24px;  color:#000; font-weight:bold;">Vendor Address:</div></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px;"><p style="font-size:24px;  color:#000; font-weight:bold;">Contact Name:</p></td></tr><tr><td align="center" valign="middle" bgcolor="#f3f9e8" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:16px;"><p style="font-size:24px;  color:#000; font-weight:bold;">Office Number:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7;  font-family:ArialBlack; height:16px; "><p style="font-size:24px;  color:#000; font-weight:bold;">Alt.Number:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:16px; " bgcolor="#f3f9e8"><p style="font-size:24px;  color:#000; font-weight:bold;">Mobile Number:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:36px;"><p style="font-size:24px; color:#000; font-weight:bold;"><br/>Email Address:</p></td></tr><tr><td align="center" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:16px;"><p style="font-size:24px; color:#000; font-weight:bold;">Business Established:</p></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:15px; "><p style="font-size:24px; font-weight:bold; color:#000;">General Liability:</p></td></tr><tr><td align="center" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:25px;"><table cellpadding="3" cellspacing="1"><tr><td style="font-size:24px; font-family:Arial Black; color:#000; font-weight:bold;"><font style="font-size:28px;" valign="middle"> </font>Workers Comp. Policy?</td></tr></table></td></tr><tr><td align="center" bgcolor="#f3f9e8" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:16px;"><p style="font-size:24px; color:#000; font-weight:bold;">Meets Compliance Standards?</p></td></tr><tr>
<td align="center" valign="middle" style="border:0.5px solid #b7b7b7; height:45px;"><p><font style="font-size:24px; font-family:ArialBlack; color:#000;font-weight:bold;">In-House Vendor?</font><br/><font style="font-size:25px;color:#000;">(Vendor affiliated with management company)</font></p></td></tr><tr><td align="center" valign="middle" bgcolor="gray" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:26px;"><table cellpadding="3" cellspacing="2"><tr><td style="font-size:21px; font-family:Arial Black; color:#fff; font-weight:bold;"><font style="font-size:24px;"> </font>TOTAL AMOUNT PROPOSED:</td></tr></table></td></tr><tr><td align="center" valign="middle" style="border:0.5px solid #b7b7b7; font-family:ArialBlack; height:17px;"><p style="font-size:24px; color:#000; font-weight:bold;">Alternate Proposal?</p></td></tr></table></td>';
			...
			$htmlcontent .=   '<table width="100%" border="0" cellspacing="2" cellpadding="2">';
							  ...
							  $vid = $v+1;
							if($BID_Vendors_info[$v]->contact_name){
							  $BID_Vendors_info[$v]->company_name=$BID_Vendors_info[$v]->contact_name;
							  } else {
							  $BID_Vendors_info[$v]->company_name=$BID_Vendors_info[$v]->company_name;
							  }
							  if($BID_Vendors_info[$v]->company_name == '')
	...
	//echo $image; exit;
		$rateimage= JURI::root().DS.'components'.DS.'com_camassistant'.DS.'assets'.DS.'images'.DS.'rating'.DS;
			...
			<img src="'.$rate_image.'" /><br/>'.$rating .' Out of 5</td></tr>
							<tr><td height="52" valign="middle" bgcolor="#f3f9e8" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; "><font size="9">&#160; <br /></font>'.$BID_Vendors_info[$v]->company_address.',<br />'.$BID_Vendors_info[$v]->city.',<br />'.$vstate.' '.$BID_Vendors_info[$v]->zipcode.'</td>  </tr><tr><td height="15" style="font-size:24px ;text-align: center; border:0.5px solid #b7b7b7; ">'.$BID_Vendors_info[$v]->name.' '.$BID_Vendors_info[$v]->lastname.'</td></tr>';
...
$html = $RFP_NOTES_summary[$li]->task_desc;
$html_notes = preg_replace('/[^(\x20-\x7F)]*/','', $html);
$html_notes_alt = str_replace('?','.', $html_notes);	

		 $htmlcontent5 ='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:40px"><tr><td colspan="2"><table width="550px" cellspacing="0" cellpadding="0" valign="middle"><tr><td width="100%" height="15" style="font-size:32px; text-align: left; vertical-align:middile; color:#000; font-weight:bold;" valign="middle">LINE ITEM #'.$lid.': <font style="font-size:24px;">'.$RFP_NOTES_summary[$li]->linetaskname.'.</font></td></tr></table></td></tr><tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$html_notes_alt.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">File(s) Provided to Vendors: ';
...
// $tasks_list[$i]->file_path = $tasks_listfile_path;
 //echo '<pre>'; print_r($tasks_list[$l]->file_path);
			...
			// $htmlcontent5 .= '<a href="http://camassistant.com/dev/index.php?option=com_camassistant&controller=popupdocs&task=open&title='.$RFP_NOTES_summary[$li]->taskuploads.'&path='.$file_link.'"> '.$RFP_NOTES_summary[$li]->taskuploads.'</a>';
			 } else {
			 $htmlcontent5 .= 'None';
			 }
...
$NOTES_summary[$T]->task_notes[$N]->add_notes = str_replace('font-size','font-size:22px ',$NOTES_summary[$T]->task_notes[$N]->add_notes);
$NOTES_summary[$T]->task_notes[$N]->add_notes = str_replace('line-height','',$NOTES_summary[$T]->task_notes[$N]->add_notes);
$NOTES_summary[$T]->task_notes[$N]->add_notes = str_replace('text-indent','',$NOTES_summary[$T]->task_notes[$N]->add_notes);										$NOTES_summary[$T]->task_notes[$N]->add_notes = str_replace('img','',$NOTES_summary[$T]->task_notes[$N]->add_notes);  
$NOTES_summary[$T]->task_notes[$N]->add_notes = str_replace('width','',$NOTES_summary[$T]->task_notes[$N]->add_notes); 
