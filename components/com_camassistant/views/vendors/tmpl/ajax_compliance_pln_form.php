...
<a href="javascript:cenceleditdocs();" class="cancel_compliance"></a><br />
    ...
    <div class="lic-pan-rightnew">
      <div class="comm">
       ...
       <input name="PLN_expdate[]" id="PLN_expdate<?PHP echo $PLN_title; ?>" type="text" class="t_field" value="" /><span style="color:red; font-size: 20px;">*</span><script type="text/javascript">G('#PLN_expdate<?PHP echo $PLN_title; ?>').datepicker({dateFormat: 'mm-dd-yy',changeYear: true,changeMonth:true,minDate: "-1y",maxDate: "+5y"});</script>
      </div>
      <div class="comm">
        <div class="in-pan">
