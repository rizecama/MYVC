...
$pdf->AddPage();
 $htmlcontent3 .='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:40px"><tr><td colspan="2">';
							 ...
							 $htmlcontent3.='<tr><td width="100%" height="15" style="font-size:32px; text-align: left; vertical-align:middile; color:#000; font-weight:bold;" valign="middle"><font style="font-size:24px;">'.$RFP_NOTES_summary[$li]->linetaskname.'</font></td></tr><tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$RFP_NOTES_summary[$li]->task_desc.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">';
...
/***************************************** RFP LINE ITEMS AND VENDOR RESPONSES ****************************************/
 ...
 $htmlcontent5 ='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:40px"><tr><td colspan="2">';
		 $htmlcontent5.='<tr><td width="100%" height="15" style="font-size:32px; text-align: left; vertical-align:middile; color:#000; font-weight:bold;" valign="middle"><font style="font-size:24px;">'.$RFP_NOTES_summary[$li]->linetaskname.'</font></td></tr><tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$RFP_NOTES_summary[$li]->task_desc.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">';
