...
<script type="text/javascript">G('#OLN_expdate<?PHP echo $compliance; ?>').datepicker({dateFormat: 'mm-dd-yy',changeYear: true,changeMonth:true,minDate: "-1y",maxDate: "+5y"});</script>
