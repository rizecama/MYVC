...
$RFP_details_inhouse1='<br/><br/><font style="font-size:35px;" valign="middle"> </font>Yes';
		...
		$filename = $pat.'properymanager/noimage2.gif';
  ...
  // echo $filename; 
//echo $RFP_info->comp_logopath; exit;
...
';
		...
		$htmlcontent9 = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td>';
  $pdf->Image('/var/www/vhosts/myvendercentor.com/httpdocs/templates/camassistant_left/images/top_border.jpg', 0, 7, 1000, 2, "", "", "", true, 550,'', false, false, 0, false, false, false);
  $htmlcontent9 .= '</td></tr>
    </table>
  <tr>
    <td><table width="100%" height="106" border="0" cellpadding="0" cellspacing="0">
	...
	//echo $image; exit;
		$rateimage= '/var/www/vhosts/myvendorcenter.com/httpdocs/'.DS.'components'.DS.'com_camassistant'.DS.'assets'.DS.'images'.DS.'rating'.DS;
			...
			<img src="'.$rate_image.'" /><br/>'.$rating .' Out of 5</td></tr>
							<tr><td height="52" valign="middle" bgcolor="#f3f9e8" style="font-size:24px; border:0.5px solid #b7b7b7;  text-align: center; "><font size="9">&#160; <br /></font>'.$BID_Vendors_info[$v]->company_address.',<br />'.$BID_Vendors_info[$v]->city.',<br />'.$vstate.' '.$BID_Vendors_info[$v]->zipcode.'</td>  </tr><tr><td height="15" style="font-size:24px ;text-align: center; border:0.5px solid #b7b7b7; ">'.$full_contactname.'</td></tr>';
...
$checkglobal	=	$log->checkglobalstandards($RFP_info->id,$master);
	if( $checkglobal == 'success' )	{
		...
		/*if($BID_Vendors_info[$v]->proposedvendorid == '1767'){
		echo "FIRM: ".$total_managers[$t]->cust_id."<br />".$preferred[$v]->id.'<br /><br />';
				...
				echo $totalprefers_new_occ."<br />" ;
				echo $totalprefers_new_omi."<br />" ;
				exit;
			}*/	
			...
			if($totalprefers_new_gli == 'success' && $totalprefers_new_aip == 'success' && $totalprefers_new_wci == 'success' && $totalprefers_new_umb == 'success' && $totalprefers_new_pln == 'success' && $totalprefers_new_occ == 'success' && $totalprefers_new_omi == 'success')
				...
				else
				{
					...
					$color_stand = 'gray' ;
					$standards = "<span style='color:#ff6264; font-weight:bold;'>N/A</span>";
	}	
...
$notes = '<span style="font-size:24px;"><b>NOTES: </b><br />'.$html_notes.'</span>';
                                  }
                                  else
                                  {
...
$other_price_sql_s = "SELECT `price_other_items` FROM #__cam_vendor_proposals  where rfpno='".$RFP_info->id."' AND (proposaltype='Submit' OR proposaltype='resubmit') AND proposedvendorid  ='".$vendors_cnt[$s]->proposedvendorid. "' AND Alt_bid != 'yes' ";
...
<div>ITEMIZED PRICING BREAKDOWN</div>
  ...
  $line_cnt=count($RFP_NOTES_summary);
							 ...
							 for($li=0; $li<$line_cnt; $li++)
							 {
									 ...
									 {
									  	//echo '<pre>'; print_r($RFP_NOTES_summary[$li]);
										  $lineitemprice .= ' <tr> <td align="center" height="59" valign="middle" style="border:0.5px solid #b7b7b7;"><br/><font style="font-size:26px;  font-family:Arial; font-weight:bold; color:#000;">Line Item #'.($li+1).' Pricing:</font> <font style="font-size:24px; font-family:Arial;">'.$RFP_NOTES_summary[$li]->linetaskname.'</font></td></tr>';
		 ...
		 //$vendors_cnt = $vendor_ids;
		  $vendors_cnt = $this->vendors_cnt;
			...
			//$htmlcontentotherprice .='<tr><td colspan="2"><table border="1" width="100%" cellspacing="0" cellpadding="3"><tr><td style="font-size:19px; text-align: left; ">';
							...
							$db =& JFactory::getDBO();
							$other_price_sql = "SELECT `price_other_items` FROM #__cam_vendor_proposals  where rfpno='".$RFP_info->id."' AND (proposaltype='Submit'Or proposaltype='resubmit') AND proposedvendorid  ='".$BID_Vendors_info[$z]->proposedvendorid. "' AND Alt_bid = 'yes' ";
							$db->setQuery($other_price_sql);
...
class checkstatus
		{
			...
			$data_omi = $db->loadObjectList();
				...
				else if( $data_gli || $data_aip || $data_umb || $data_wci || $data_lic || $data_omi )	{
					$existance =  "success";
				}
