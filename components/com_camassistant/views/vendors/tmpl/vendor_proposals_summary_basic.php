...
//Special basic request
		$htmlcontent3 =  '<table width="550px" cellpadding="3"><tr align="center"><td colspan="2" bgcolor="#7ab800" style="color:#FFF; font-weight:bold; font-family:ArialBlack; font-size:24px;">SCOPE OF WORK(SOW)</td></tr></table><table border="1" width="550px" cellspacing="0" cellpadding="3"><tr><td style="font-size:24px; text-align: left; ">';
		$htmlcontent3 .= "<br /><br />".nl2br($RFP_info->jobnotes);
		$htmlcontent3 .= '</td></tr></table>';
		$htmlcontent3 .=  '<BR /><table border="1" width="550px" cellspacing="0" cellpadding="3"><tr><td style="font-size:24px; text-align: left; ">';
		...
		//Special basic request
             ...
             $line_cnt=count($RFP_NOTES_summary);
							...
							// $RFP_NOTES_summary[$li]->task_desc = nl2br(wordwrap($RFP_NOTES_summary[$li]->task_desc, 140, "\n"));
                                                       ...
                                                       $pdf->AddPage();
 $htmlcontent3 .='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:0px"><tr><td colspan="2">';
                                                     // echo $li;
                                                        // echo '<pre>'; print_r($RFP_NOTES_summary[$li]->task_desc);
							 $htmlcontent3 .='<tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$RFP_NOTES_summary[$li]->task_desc.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">';
...
//echo 'anand__';
	...
	//	$COM = $this->COM_docs_summary_new;
		...
		/*$htmlcontent4 .='<tr><td colspan="2">';
		$htmlcontent4 .='This is for samople SOW text...';
		$htmlcontent4 .='</td><tr>';*/
...
/***************************************** RFP LINE ITEMS AND VENDOR RESPONSES ****************************************/
		...
		//Special basic request
		$htmlcontent5 =  '<table width="550px" cellpadding="3"><tr align="center"><td colspan="2" bgcolor="#7ab800" style="color:#FFF; font-weight:bold; font-family:ArialBlack; font-size:24px;">SCOPE OF WORK(SOW)</td></tr></table><table border="1" width="550px" cellspacing="0" cellpadding="3"><tr><td style="font-size:24px; text-align: left; ">';
		$htmlcontent5 .= "<br /><br />".nl2br($RFP_info->jobnotes);
		$htmlcontent5 .= '</td></tr></table>';
		$htmlcontent5 .=  '<BR /><table border="1" width="550px" cellspacing="0" cellpadding="3"><tr><td style="font-size:24px; text-align: left; ">';
		$htmlcontent5 .= "<strong>UPLOADED FILES:<br /></strong><br />";
		$bascifiles = $this->bascifiles ;
		for( $f=0; $f<count($bascifiles); $f++ ){
				if( $bascifiles[$f]->filename != '' && $bascifiles[$f]->filename != ' ' ) {
			$htmlcontent5 .= '<a style="color:#7ab800; text-decoration:none;" href="'.JURI::root().'index2.php?option=com_camassistant&controller=documents&task=viewbasicfile&filename='.$bascifiles[$f]->filename.'&filepath='.$bascifiles[$f]->filepath.'&rfpid='.$RFP_info->id.'">'.$bascifiles[$f]->filename.'</a><br />';
		}
		}
		$htmlcontent5 .= '</td></tr></table>';
    ...
    $pdf->AddPage();
 $htmlcontent5 .='<table width="550px" border="0" cellspacing="0" cellpadding="3" align="center" style="padding-top:0px"><tr><td colspan="2">';
		 $htmlcontent5.='<tr><td colspan="3" style="font-size:30px; text-align: left;" width="500px"><font style="font-size:23px;" width="500px">'.$RFP_NOTES_summary[$li]->task_desc.'</font><p style="color:#7ab800; font-weight:bold; font-size:24px;">';
