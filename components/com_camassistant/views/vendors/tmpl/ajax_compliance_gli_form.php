...
<a href="javascript:cenceleditdocs();" class="cancel_compliance_w9"></a><br />
    ...
    <input name="GLI_end_date[]" id="GLI_end_date<?PHP echo $GLI_title; ?>" type="text" class="t_field" size="10" value=""/><span style="color:red; font-size: 20px;">*</span><script type="text/javascript">G('#GLI_end_date<?PHP echo $GLI_title; ?>').datepicker({dateFormat: 'mm-dd-yy',changeYear: true,changeMonth:true,minDate: "-1y",maxDate: "+5y"});</script>
	</div>
	<div class="in-pan1">
