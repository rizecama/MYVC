...
<tr class="table_blue_row" style="text-align:center; background:none;"><td><font style="font-weight:bold;font-size:15px; font-family: arial; line-height:28px;" color=" #4d4d4d">UPLOAD YOUR PROPERTY IMAGE</font>	</td></tr>
<tr style="text-align:center;"><td>
<?php 
//$type = 'gif, jpg, JPG, png, PNG, gif, GIF, jpeg, JPEG';
$type = 'gif, jpg, JPG, png, PNG, gif, GIF, jpeg, JPEG, pdf, PDF';
echo '<div style="color:#4d4d4d; font-family: arial; font-size:13px; line-height:19px;">Note: Image will appear on all Requests for this property<br/>Compatible File Types: <span style="font-weight:bold; color: #4d4d4d;">gif - jpg - png</span></div>';
echo"</br>";
...
<input title="Upload Document"  type="file" id="uploadfile_origin" onchange="javascript: getreplaceimage(this.value);" name="property_image" class="file_input_hidden">
</div>
</td></tr></tbody></table>
</td>
</tr>
...
<input type="hidden" name="task" value="saveeditpropertfile" />
...
<!--<tr><td>NOTE: THIS LOGO/IMAGE WILL DISPLAY ON PROPOSAL REPORTS AS A REPRESENTATION OF YOUR COMPANY.</td></tr>-->
<?php exit; ?>