...
<a href="<?php echo $backlink;?><?php echo $additional; ?>"><img src="templates/camassistant_left/images/back.png" alt="info" /></a>
<?php } else {?>
<a href="<?php echo $backlink;?><?php echo $additional; ?>"><img src="templates/camassistant_left/images/back.png" alt="info" /></a>
<?php } ?>
</div>
...
<a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=82&controller=popupdocs&task=sopenfiles&spid=<?php echo $_REQUEST['spid']; ?>&smid=<?php echo $_REQUEST['smid']; ?>&spath=<?php echo $_REQUEST['spath']."/".$this->sopenfiles['folders'][$i]; ?>&folder_name=<?php print_r($this->sopenfiles['folders'][$i]); ?>&fileplace=<?php echo $_REQUEST['fileplace']."-->".$this->sopenfiles['folders'][$i];?>&type=<?php echo $type; ?>&Itemid=<?php echo $_REQUEST['Itemid']; ?>&taxid=<?php echo $taxid; ?>&pid=<?php echo $_REQUEST['pid']; ?>&taskid=<?php echo $_SESSION['taskid'];?><?php echo $additional; ?>"><img src="images/folder_icon.png"  alt="folder" /></a></td>

<td align="left" valign="middle">
<a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=82&controller=popupdocs&task=sopenfiles&spid=<?php echo $_REQUEST['spid']; ?>&smid=<?php echo $_REQUEST['smid']; ?>&spath=<?php echo $_REQUEST['spath']."/".$this->sopenfiles['folders'][$i]; ?>&folder_name=<?php print_r($this->sopenfiles['folders'][$i]); ?>&fileplace=<?php echo $_REQUEST['fileplace']."-->".$this->sopenfiles['folders'][$i];?>&type=<?php echo $type; ?>&Itemid=<?php echo $_REQUEST['Itemid']; ?>&taxid=<?php echo $taxid; ?>&pid=<?php echo $_REQUEST['pid']; ?>&taskid=<?php echo $_SESSION['taskid'];?><?php echo $additional; ?>"><?php echo str_replace('_',' ',$this->sopenfiles['folders'][$i]); ?></a>
</td>
<td align="center" valign="middle">

<a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=82&controller=popupdocs&task=sopenfiles&spid=<?php echo $_REQUEST['spid']; ?>&smid=<?php echo $_REQUEST['smid']; ?>&spath=<?php echo $_REQUEST['spath']."/".$this->sopenfiles['folders'][$i]; ?>&folder_name=<?php print_r($this->sopenfiles['folders'][$i]); ?>&fileplace=<?php echo $_REQUEST['fileplace']."-->".$this->sopenfiles['folders'][$i];?>&type=<?php echo $type; ?>&Itemid=<?php echo $_REQUEST['Itemid']; ?>&taxid=<?php echo $taxid; ?>&pid=<?php echo $_REQUEST['pid']; ?>&taskid=<?php echo $_SESSION['taskid'];?><?php echo $additional; ?>">OPEN</a>
...
$ext = substr(strrchr($filename, "."), 1);
 ?>
  <tr class="table_blue_rowdots2">
<td align="center" valign="bottom"><a href="index2.php?option=com_camassistant&controller=popupdocs&task=open&doc_title=<?php echo $this->sopenfiles['files'][$i]; ?>&path=<?php echo $_REQUEST['spath']; ?>&taskid=<?php echo $_SESSION['taskid'];?>&Itemid=76 "><img src="templates/camassistant_inner/images/images_<?php echo $ext; ?>.png" /></a></td>
<td align="left" valign="middle"><a href="index2.php?option=com_camassistant&controller=popupdocs&task=open&doc_title=<?php echo $this->sopenfiles['files'][$i]; ?>&path=<?php echo $_REQUEST['spath']; ?>&taskid=<?php echo $_SESSION['taskid'];?>&Itemid=76 "><?php echo str_replace('_',' ',$this->sopenfiles['files'][$i]); ?></a></td>
...
<?php } else { ?>
<a href="javascript:void(0);" onclick="addsharedfile('shared','<?php echo $docpath; ?>','<?php print_r($_SESSION['taskid']); ?>','<?php print_r($this->sopenfiles['files'][$i]); ?>');">ADD</a>
<?php } ?>
