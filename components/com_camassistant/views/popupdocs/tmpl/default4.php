...
function addmasterfile(id,data,taskid,filename){
strOut = id + '-' + data;
...
</script><link rel="stylesheet" href="templates/camassistant_inner/css/style.css" type="text/css" />
...
?>
<div align="right" style="padding-top:10px; padding-right:10px;"><a href="<?php echo $backlink;?><?php echo $additional;?>"><img alt="info" src="templates/camassistant_left/images/back.png"/></a></div>
<div id="new_bar">
...
<td align="center" valign="bottom"><a href="index2.php?option=com_camassistant&controller=popupdocs&taskid=<?php print_r($_SESSION['taskid']); ?>&task=openfiles&Itemid=<?php echo $_REQUEST['Itemid']; ?>&pid=<?php echo $_REQUEST['pid']; ?>&mid=<?php echo $_REQUEST['mid']; ?>&path=<?php echo $_REQUEST['path']."/".$this->openfiles['folders'][$i]; ?>&folder_name=<?php print_r($this->openfiles['folders'][$i]); ?>&fileplace=<?php echo $_REQUEST['fileplace']."-->".$this->openfiles['folders'][$i];?>&taxid=<?php echo $taxid; ?><?php echo $additional; ?>"><img src="images/folder_icon.png"  alt="folder" /></a></td>
    
<td align="left" valign="middle"><a href="index2.php?option=com_camassistant&controller=popupdocs&taskid=<?php print_r($_SESSION['taskid']); ?>&task=openfiles&Itemid=<?php echo $_REQUEST['Itemid']; ?>&pid=<?php echo $_REQUEST['pid']; ?>&mid=<?php echo $_REQUEST['mid']; ?>&path=<?php echo $_REQUEST['path']."/".$this->openfiles['folders'][$i]; ?>&folder_name=<?php print_r($this->openfiles['folders'][$i]); ?>&fileplace=<?php echo $_REQUEST['fileplace']."-->".$this->openfiles['folders'][$i];?>&taxid=<?php echo $taxid; ?><?php echo $additional; ?>"><?php echo str_replace('_',' ',$this->openfiles['folders'][$i]); ?></a>
</td>

<td align="center" valign="middle"><a href="index2.php?option=com_camassistant&controller=popupdocs&taskid=<?php print_r($_SESSION['taskid']); ?>&task=openfiles&Itemid=<?php echo $_REQUEST['Itemid']; ?>&pid=<?php echo $_REQUEST['pid']; ?>&mid=<?php echo $_REQUEST['mid']; ?>&path=<?php echo $_REQUEST['path']."/".$this->openfiles['folders'][$i]; ?>&folder_name=<?php print_r($this->openfiles['folders'][$i]); ?>&fileplace=<?php echo $_REQUEST['fileplace']."-->".$this->openfiles['folders'][$i];?>&taxid=<?php echo $taxid; ?><?php echo $additional; ?>">OPEN</a>

<?PHP $db =& JFactory::getDBO(); $user =& JFactory::getUser(); if($user->user_type == '11'){ ?> <img src="templates/camassistant_left/images/links_devider.gif" alt="liks devider" hspace="8" />  
...
<?php } else { ?>
<a href="javascript:void(0);" onclick="addmasterfile('<?php echo $_REQUEST['pid']; ?>','<?php echo $path; ?>','<?php print_r($_SESSION['taskid']); ?>','<?php print_r($this->openfiles['files'][$i]); ?>');">ADD</a>
...
<ul>
<li  style=" background:none;"><a class="modal" id="links1"  title="Add Folder"  href="index2.php?option=com_camassistant&controller=popupdocs&task=addfolder&parentid=1&pid=<?php echo $_REQUEST['pid']; ?>&mid=<?php echo $_REQUEST['mid']; ?>&path=<?php echo $_REQUEST['path']; ?>" rel="{handler: 'iframe', size: {x: 400, y: 200}}" ><img src="images/new_folder.png" alt="add a new folder" width="45" height="39" align="absmiddle" /> </a><a class="modal" id="links1"  title="Add Folder"  href="index.php?option=com_camassistant&controller=popupdocs&task=addfolder&parentid=1&pid=<?php echo $_REQUEST['pid']; ?>&mid=<?php echo $_REQUEST['mid']; ?>&path=<?php echo $_REQUEST['path']; ?>" rel="{handler: 'iframe', size: {x: 400, y: 200}}" >+Add a new Folder  </a></li>

<li><a class="modal" id="links1"  title="Add Folder"  href="index2.php?option=com_camassistant&controller=popupdocs&task=addfile&parentid=1&pid=<?php echo $_REQUEST['pid']; ?>&mid=<?php echo $_REQUEST['mid']; ?>&path=<?php echo $_REQUEST['path']; ?>" rel="{handler: 'iframe', size: {x: 420, y: 250}}" > +Upload a file to this folder <img src="images/upload_folder.png" alt="Upload a file to this folder" width="37" height="36" align="middle" /></a></li> 
</ul>
</div>
</div></div>
<div class="clear"></div>
