...
//echo '<pre>'; print_r($count_enable); echo '</pre>';
...
<?php
?>
<input type="hidden" value="compliance_status_report_pdf" name="task" />
<?php
$link = '1';
$download_email = 'index.php?option=com_camassistant&controller=rfpcenter&task=compliance_status_report_pdf&send=mail';
}
else{
$download = 'index.php?option=com_camassistant&controller=rfpcenter&task=compliance_status_report';
$link = '0';
$download_email = 'index.php?option=com_camassistant&controller=rfpcenter&task=compliance_status_report&send=mail';
}
?>
...
?>
	...
	?>
        <h2 class="vender-category-title"><span class="category-key"><?php echo $key;?></span></h2>
       <?php 
	    $count = count($value) ;
            ...
            <div class="wrapper">
			   ...
			   <ul class="compliance-category-column">
                        <li data-category="w9" class="compliance <?php echo $type;?>"  style="display:<?php echo $display_w9; ?>">
						 ...
						 <li class="company-compliance-status <?php echo $vertical_middle; ?>" style="display:<?php echo $display_cont1; ?>">
                           <div class="<?php echo $vendortype_c ;?>"><span class="nondoctype"><?php echo $exp[0];?></span></div>
                           </li>
