...
<p></p>
<div id="chk">
<input type="radio" value="1" name="category" id="category_1" class="hidden_apple" />
<a id="one" href="javascript:void(0)" rel='1' class="radio-picture" >&nbsp;</a>
<input type="radio" value="2" name="category" id="category_2" class="hidden_apple" />
<a id="two" href="javascript:void(0)" rel='2' class="radio-picture" >&nbsp;</a>
<input type="radio" value="3" name="category" id="category_3" class="hidden_apple" />
<a id="three" href="javascript:void(0)" rel='3' class="radio-picture" >&nbsp;</a>
<input type="radio" value="4" name="category" id="category_4" class="hidden_apple" />
<a id="four" href="javascript:void(0)" rel='4' class="radio-picture" >&nbsp;</a>
<input type="radio" value="5" name="category" id="category_5" class="hidden_apple" />
...
<textarea name="rating_comment" id="ctl00_CPHContent_txtComments" rows="5" cols="70"></textarea>
