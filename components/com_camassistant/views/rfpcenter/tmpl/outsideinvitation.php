...
<div id="invite-popup">
<p style="text-align:left">A Vendor's email address is preferred but NOT required, as all invitations are copied to MyVendorCenter. Anything marked with a RED ARROW is required.</p><br />
...
<div class="invite-popup-main" style="width:420px; float:right">
<div class="invite-popup-left">
<img vspace="10" border="0" align="right" src="templates/camassistant_left/images/CancelButton.gif" style="cursor:pointer;" alt="Submit Text" id="closewindow">
</div>
