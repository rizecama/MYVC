			   ...
			   <tr width="100%">
            	<td width="100%">
                	<table width="100%" bgcolor="'.$style.'">
						...
						$htmlcontent .='<td>
								<table valign="middle" height="35">
									<tr>
										<td width="35">
											<img src="templates/camassistant_left/images/'.$image_status1.'" width="35"  >
										</td>
										<td valign="middle" >
											<span style="color:'.$image_text1.'; display:block; vertical-align: middle; line-height:9px;" >&nbsp;'.$exp[0].'</span>
										</td>
									</tr>
								</table>
					        </td>
							 ...
							 <table valign="middle" height="35">
									<tr>
										<td width="35" valign="middle">
											<img src="templates/camassistant_left/images/'.$image_status.'" width="35"  >
										</td>
										<td valign="middle" >
											<span style="color:'.$image_text.'; display:block;vertical-align: middle; line-height:9px;"> &nbsp;'.$exp[1].'&nbsp;Documents </span>
										</td>
									</tr>
								</table>
					         </td>
