...
<script>
	...
	N('.editstandards').live('click',function(e) {
		N('.editoption').hide();
		N('.editnewinfotext').hide();
		N('.editpropicnew').hide();
...
{
?>
<tr><td><input id="notself" style="margin-top:0px;" <?php  echo $checked1; ?> type="radio" value="notself" name="permission" class="first" /></td><td> <strong>-  I would like to set different Insurance and Licensing standards every time I create a new Request</strong> </td></tr>
<tr height="5"></tr>
