...
<span style="padding-left:0px; color:#fff;"><strong>RFP CONTACT INFO</strong></span></div>
</div>
...
<div id="topborder_row" align="right"><td><a href="index.php?option=com_camassistant&controller=proposals&Alt_Prp=<?PHP echo $Alt_Prp;?>&task=Proposal_edit&Proposal_id=<?PHP echo $Proposal_id;?>&vendor_id=<?PHP echo $user->id;?>&rfp_id=<?PHP echo $RFP->id; ?>&reject=<?PHP echo $_REQUEST['reject']; ?>&act=Draft&status=<?PHP echo $Form_status; ?>&jobtype=<?php echo $jobtype; ?>&mailtype=<?php echo $mailtype; ?>&Itemid=<?PHP echo $Itemid;  ?>"><img src="templates/camassistant_left/images/Edit.png" alt="Continue Editing" /></a></td><td><a href="index.php?option=com_camassistant&controller=proposals&Alt_Prp=<?PHP echo $Alt_Prp;?>&task=Proposal_save_as&Proposal_id=<?PHP echo $Proposal_id;?>&act=submitproposal&vendor_id=<?PHP echo $user->id;?>&rfp_id=<?PHP echo $RFP->id; ?>&submit_type=Submit&sendmailsupport=yes&jobtype=<?php echo $jobtype; ?>&mailtype=<?php echo $mailtype; ?>&Itemid=106" onclick="proposalpopup();"><img src="templates/camassistant_left/images/submit.png" alt="Submit Proposal" /></a></td></div></div>
</div>
<?PHP }  else { ?> 
