...
$motinterested = JRequest::getVar('mot_interested','');
if( $notinterested )
	$notinterested = $notinterested;
else
	$notinterested = $motinterested;
...
<div id="i_bar_gr">
<div id="i_bar_txt" style="padding-left:3px; width:632px; text-align:center;">
...
<span style="padding-left:0px;">RFP CONTACT INFO</span></div>
</div>
<?php //echo "<pre>"; print_r($RFP); echo "</pre>"; ?>

	   <div id="rpf_ifo_text" style="margin-top:-3px;">
...
$image = "<div style='margin-top:0px; line-height:20; display:inline-block; text-align:center; vertical-align:middle; width:432px; height:298px; box-shadow:1px 1px 2px 1px #808080; font-size:14px; margin-left:2px;'  >No Image available for this Property.</div>";
...
<div class="clear"></div>
<div id="i_bar_gr">
<div id="i_bar_txt" style="text-align:center; width:666px;">
<span style="padding-left:0px;">BASIC INFORMATION</span></div>
</div>
...
<br />-->
<div id="i_bar_gr">
<div style="text-align:center; width:666px;" id="i_bar_txt">
<span style="padding-left:0px;">SCOPE OF WORK (SOW)</span></div>
</div>
<div style="margin-top: 6px; padding:5px; font-size:11px;border:1px solid #CDCDCD;">
...
<table cellpadding="0" cellspacing="0">
	...
	?>
		<tr class="basicfiles<?php echo $bascifiles[$f]->id; ?>"><td><a href="index.php?option=com_camassistant&controller=documents&task=viewbasicfile&filename=<?php echo $bascifiles[$f]->filename; ?>&filepath=<?php echo $bascifiles[$f]->filepath; ?>&rfpid=<?php echo $rfp_id; ?>" class="deletebasicfile"><img id="redimagebasci" alt="delete" src="templates/camassistant_left/images/green.png"></a></td><td>&nbsp;&nbsp;
		<a id="openbasicfile" href="index.php?option=com_camassistant&controller=documents&task=viewbasicfile&filename=<?php echo $bascifiles[$f]->filename; ?>&filepath=<?php echo $bascifiles[$f]->filepath; ?>&rfpid=<?php echo $rfp_id; ?>"><?php  echo str_replace('_',' ',$bascifiles[$f]->filename) ; ?> </a></td></tr>
...
<a class="createnewrequest" onclick="javascript: return ITB_save();" ><img src="templates/camassistant_left/images/accept.gif" style="cursor:pointer;" alt="submit my intent to bid" vspace="15" /></a>-->
     <a class="decline_rfpjob" id="declineinvitation" rel="<?php echo $_REQUEST['rfp_id']; ?>" href="javascript:void(0);"></a>
	<a class="accept_rfpjob" onclick="javascript: return ITB_save();" href="javascript:void(0);"></a>
<?php if($interested == '2'){ ?>
...
<?php } ?>
 ...
 <?php } else { ?>
<?PHP if($Form_status == '') { ?>
<div id="topborder_row" align="right"><a class="createnewrequest" href="javascript:;" onClick="history.go(-1)"><img src="templates/camassistant_left/images/goback.gif" vspace="15" alt="Go Back"  /></a><?PHP if($notinterested!= '1') { ?><a class="createnewrequest" href="index.php?option=com_camassistant&controller=proposals&task=not_interested&id=<?php echo $_REQUEST['id']; ?>&rfp_id=<?php echo $_REQUEST['rfp_id']; ?>"><img src="components/com_camassistant/assets/images/NotInterested.gif" vspace="15" alt="Not Interested"  /></a><?php } ?><a class="createnewrequest" onclick="javascript: return ITB_save();" ><img src="templates/camassistant_left/images/SubmitMyIntentToBid.gif" style="cursor:pointer;" alt="submit my intent to bid" vspace="15" /></a></div></div>
<?PHP } else { ?>
<?PHP if($Alt_bid == 'yes') { ?>
<div id="topborder_row" align="right"><a class="createnewrequest" href="javascript: location.reload(true);"><img src="templates/camassistant_left/images/discardchanges.gif" alt="save as draft" width="194" height="47" /></a><?PHP if($notinterested!= '1') { ?><a class="createnewrequest" href="index.php?option=com_camassistant&controller=proposals&task=not_interested&id=<?php echo $_REQUEST['id']; ?>&rfp_id=<?php echo $_REQUEST['rfp_id']; ?>"><img src="components/com_camassistant/assets/images/NotInterested.gif" vspace="15" alt="Not Interested"  /></a><?php } ?><a href="javascript: Alt_saveasdraft();"><img src="templates/camassistant_left/images/saveasdraft.gif" alt="save as draft" width="154" height="46" /></a><a class="createnewrequest" href="javascript: Alt_saveassubmit('review');"><img src="templates/camassistant_left/images/review_submit.gif" alt="review &amp; submit" /></a></div></div>
<?PHP } else { ?>
<div id="topborder_row" align="right"><a class="createnewrequest" href="javascript: location.reload(true);"><img src="templates/camassistant_left/images/discardchanges.gif" alt="save as draft" width="194" height="47" /></a><?PHP if($notinterested!= '1') { ?><a class="createnewrequest" href="index.php?option=com_camassistant&controller=proposals&task=not_interested&id=<?php echo $_REQUEST['id']; ?>&rfp_id=<?php echo $_REQUEST['rfp_id']; ?>"><img src="components/com_camassistant/assets/images/NotInterested.gif" vspace="15" alt="Not Interested"  /></a><?php } ?><a class="createnewrequest" href="javascript: fun_saveasdraft();"><img src="templates/camassistant_left/images/saveasdraft.gif" alt="save as draft" width="154" height="46" /></a><a class="createnewrequest" href="javascript: fun_saveassubmit();"><img src="templates/camassistant_left/images/review_submit.gif" alt="review &amp; submit" /></a></div></div>
<?PHP } ?>
<?PHP } //if($Form_status == '') 
}
?>
...
<input type="hidden" name="reqtype" value="<?PHP echo $_REQUEST['reqtype']; ?>" />
...
<input type="hidden" value="yes" name="jobtype" />
</form>
<?php } ?>