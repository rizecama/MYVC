...
<form style="padding:0px; margin:0px;" action="index.php?option=com_camassistant&controller=proposals&task=save_addnotes&rfp_id=<?php echo $rfp_id; ?>&id=<?php echo $NOTES[0]->id; ?>" method="post" name="Addnotesform" >
<div id="l_box_midbg">
