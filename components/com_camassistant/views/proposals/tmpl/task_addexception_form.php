...
<form style="padding:0px; margin:0px;" action="index.php?option=com_camassistant&controller=proposals&task=save_addexception&rfp_id=<?php echo $rfp_id; ?>&id=<?php echo $NOTES[0]->id; ?>" method="post" name="Addexceptionform" >
<div id="l_box_midbg">
