...
<input type="text" style="max-width: 238px; padding-left:88px; width: 100%; color:gray; margin-right: 10px; height: 29px;"  id="email" name="email" value="<?php echo $email;?>">
</div>
</div>
...
<input type="hidden" value="<?php echo $propertyid;?>" name="property_name">
