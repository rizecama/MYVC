...
function getcompstatus(vendorid){
	el='<?php  echo Juri::base(); ?>index.php?option=com_camassistant&controller=vendorscenter&task=preferredcompliance&vendorid='+vendorid;
	var options = $merge(options || {}, Json.evaluate("{handler: 'iframe', size: {x: 650, y:800}}"))
	SqueezeBox.fromElement(el,options);
	}
...
<div class="managerrecs">
	...
	<div class="recsname">
	<span><?php echo $recommends[$r]->sendername; ?></span> has recommended this Vendor:
...
<span><font style="font-weight:bold;">
<?php 
$user =& JFactory::getUser();
if($user->user_type == '13' && $user->accounttype == 'master') 
echo "CORPORATE PREFERRED VENDORS";
else
echo "MY VENDORS ";
?>
 </font></span></div>
...
?>		 
  ...
  <div id="preferredvendorsinvitations">
   <div class="search-panel-middlepre checkbox_vendor">
	  ...
	  <input type="checkbox" value="<?php echo  $am->vid; ?>" name="preferred" class="preferredvendors<?php echo $final_display; ?>" />
	   <?php } 
	  else { ?>
	...
	?>
        ...
        <li><a style="font-weight:normal; color:gray;" href="mailto:<?php echo $am->inhousevendors; ?>?cc=support@camassistant.com"><?php echo $am->inhousevendors; ?></a></li>
        </ul>
	...
	<div class="search-panel-image_rfp compliant_vendor" style="padding-left:16px;">
		 ...
		 <?php  if($globe != 'fail'){ ?>
			<a href="index.php?option=com_camassistant&controller=vendorscenter&task=preferredcompliance&vendorid=<?php echo $am->id; ?>" rel="{handler: 'iframe', size: {x: 650, y: 700}}" class="modal" id="<?php echo $id; ?>" title="<?php echo $title; ?>"><?php echo $text; ?></a>
			<?php } else { ?>
			<a id="nostandards" href="javascript:void(0);" onclick="javascript:getcompstatus(<?php echo $am->id; ?>);" title="No Standards">N/A</a>
			<?php 
			}?>		
...
<a style="text-decoration: none;" mce_style="text-decoration: none;" title="Click here" class="modal" rel="{handler: 'iframe', size: {x: 680, y: 530}}" href="index2.php?option=com_content&amp;view=article&amp;id=250&amp;Itemid=113"><img src="templates/camassistant_left/images/info_icon2.png" style="float:right;"> </a>
    ...
    <div id="i_bar_txt" style="text-align:center;  padding:8px 0 0 35px;">
<span><font style="font-weight:bold;">CORPORATE PREFERRED VENDORS</font></span></div>
</div>
   ...
   <div class="search-panel-middlepre checkbox_vendor">
	...
	?>
		...
		<div class="search-panel-image_rfp compliant_vendor" style="padding-left:16px;">
	  	  <p align="center" style="color:; display:block; margin-bottom:7px; font-weight:bold; padding-right:0px;">
		  <?php  if($globe != 'fail'){ ?>
			<a href="index.php?option=com_camassistant&controller=vendorscenter&task=preferredcompliance&vendorid=<?php echo $am->v_id; ?>" rel="{handler: 'iframe', size: {x: 650, y: 700}}" class="modal" id="<?php echo $id; ?>" title="<?php echo $title; ?>"><?php echo $text; ?></a>
			<?php } else { ?>
			<a id="nostandards" href="javascript:void(0);" onclick="javascript:getcompstatus(<?php echo $am->v_id; ?>);" title="No Standards">N/A</a>
			<?php }?>
	...
	<?php
		...
		<div class="search-panel-image_rfp compliant_vendor" style="padding-left:16px">
		  ...
		  $vidc = $am->id;
			?>
		  <?php  if($globe != 'fail'){ ?>
			<a href="index.php?option=com_camassistant&controller=vendorscenter&task=preferredcompliance&vendorid=<?php echo $vidc; ?>" rel="{handler: 'iframe', size: {x: 650, y: 700}}" class="modal" id="<?php echo $id; ?>" title="<?php echo $title; ?>"><?php echo $text; ?></a>
			<?php } else { ?>
			<a id="nostandards" href="javascript:void(0);" onclick="javascript:getcompstatus(<?php echo $vidc; ?>);" title="No Standards">N/A</a>
			<?php }
			
			?>
<?php
if( $am->subscribe_type == 'free' ) { ?>
<div class="unverifiedvendor"><a href="javascript:void(0);" onclick="unverified(<?php echo $vidc; ?>,'unverified');" title="Click for more info">UNVERIFIED</a></div>
<?php } else {  ?>
...
<li> 
<div id="closereq" name="closereq" value="Cancel"><img src="templates/camassistant_left/images/cancel.jpg" /></div>
<div id="donereq"  name="donereq" value="Ok"><img src="templates/camassistant_left/images/submit.jpg" /></div>
</li>
</ul>
</div>
</div>
