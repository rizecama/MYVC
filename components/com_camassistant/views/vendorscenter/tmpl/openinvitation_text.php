...
<body>
<div id="i_bar_terms" style="margin-bottom:-6px; margin-left:19px; margin-top:15px; width:518px; text-align:center;">
<div id="i_bar_txt_terms">
<span> <font style="font-weight:bold; color:#FFF;">OPEN INVITATION</font></span>
</div></div>
<?php 
$text = $this->opentext;?>
