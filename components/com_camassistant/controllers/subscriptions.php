...
&nbsp;
<div id="i_icon"><a href="/dev/index2.php?option=com_content&amp;view=article&amp;id=71&amp;Itemid=113" rel="{handler: 'iframe', size: {x: 680, y: 530}}" class="modal" title="Click here" style="text-decoration: none;"><img src="/dev/templates/camassistant_left/images/info_icon2.png"> </a></div>
