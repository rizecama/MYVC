...
$_FILES['file']['name'] = str_replace($ext,$ext1,$_FILES['file']['name']);
	$_FILES['file']['name'] = preg_replace("/[&'`:;={}!@#$%^*(?)-+|]/"," ",$_FILES['file']['name']);	
...
//echo "<pre>";print_r($_REQUEST); exit;
	...
	$sdocTitle = ereg_replace('"',' ',$sdocTitle);
	$sdocTitle = ereg_replace('-',' ',$sdocTitle);
	$sdocTitle = str_replace('\\',' ',$sdocTitle);
	$sdocTitle = str_replace('.',' ',$sdocTitle);
...
if(substr($_REQUEST['mainpath'], -1) == '/'){
$_REQUEST['mainpath'] = $_REQUEST['mainpath'];
}
else {
$_REQUEST['mainpath'] = $_REQUEST['mainpath']."/";
}
