	...
	//echo $image; exit;
		$rateimage= 'https://camassistant.com/live'.DS.'components'.DS.'com_camassistant'.DS.'assets'.DS.'images'.DS.'rating'.DS;
		  ...
		  $htmlcontent .= '<tr><td height="15" style="'.$class.'">$'.$BID_Vendors_info[$v]->proposal_total_price.'</td></tr>
			...
			$htmlcontent .= '<br /><table><tr><td style="font-size:23px; align:left;"><font color="red">'.$ast.' </font>Designates exception for 1 or more line items. 	Please see vendor notes for details.</td></tr></table>';  
...
/***************************************** RFP LINE ITEMS AND VENDOR RESPONSES ****************************************/
		...
		'.$RFP_info->mailaddress.'<br />'.$RFP_info->comp_city.', '.$state_name.' '.$RFP_info->comp_zip.'<br /><strong>P</strong>: ('.$com_phone[0].')'.$com_phone[1].'-'.$com_phone[2].'</td>
			...
			//$htmlcontent3 .='<tr><td colspan="2" style="font-size:20px; text-align: left;"><span style="color:#21314d; font-weight:bold;"><br /><br />LINE ITEM #'.$lid.':</span> '.$RFP_NOTES_summary[$li]->task_desc.'<p style="color:#7ab800; font-weight:bold;">Attachment for Line Item #'.$lid.': '.$RFP_NOTES_summary[$li]->title.'</p></td></tr>';
