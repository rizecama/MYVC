...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		if(!$this->tmpl['plugin']->element) {
			echo JText::_('No Plugin Installed');
		} else {
			if (JFile::exists(JPATH_COMPONENT_ADMINISTRATOR.DS.'views'.DS.'phocaplugins'.DS.'tmpl'.DS.'default_'.$this->tmpl['plugin']->element.'.php')) {
				echo $this->loadTemplate($this->tmpl['plugin']->element);
			} else {
				echo JText::_('Plugin does not exist');
			}
		}
