 ...
 * @version     $Id: install.sh404sef.php 2163 2011-11-19 11:24:44Z silianacom-svn $
 *
 */
...
function shUpdateDBStructure() {
  ...
  /* version 2.4: added OpenGraph data columns to meta data table
  ...
  if (!empty( $subQueries)) {
    ...
    // prepend query
    $query = 'alter table ' . $db->nameQuote( '#__sh404SEF_meta') . $subQueries;
