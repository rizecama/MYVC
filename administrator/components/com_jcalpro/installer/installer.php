 ...
 **********************************************
 ...
 $Id: installer.php 706 2011-02-28 16:23:10Z jeffchannell $
...
require_once( dirname(__FILE__).DS.'installer.html.php' );
require_once( dirname(__FILE__).DS.'installer.class.php' );
...
function extcalInstaller( $option, $client, $opt )
{
  ...
  $classMap = array(
    	...
    	if (array_key_exists ( $element, $classMap )) {
    	  require_once( dirname(__FILE__).DS.$element.DS.$element.".class.php" );
