...
//////////////////////////////////////// FORMS ///////////////////////////////////
    ...
    */
	 ...
	 * @param array $row
	 */
    function formsEdit($formId, $row,$camidus)
    {
		...
		function transferItems(){
			var form = document.adminForm;
				...
				form.camindustry.value 				= document.getElementById('camindustry').value;
				form.line_item_price.value		= document.getElementById('line_item_price').value;
        ...
        <table border="0" width="100%" class="adminform">
            <tr>
                <td class="components" valign="top">
					...
					<!-- # following code is added to show linetask component in components panel. this link is shown as new component in the components panel. and give the uniqu component id (here I taken 16 ), give this id as parameter of displayTemplate function. insert the id(16) in jos_rsform_component_types as ComponentTypeId,	ComponentTypeName is custom name for the component. In jos_rsform_component_type_fields create custom parameters for the component. go to  frontend/components/com_rsform/controller/adapter.php add the component id  to $RSform_config['component_ids'] array, in function.php add the case lineItemTask in RSpreviewComponent(). To show component on frontend go to functions.php (fornt end file) add case in function RSfrontComponentBody with our component name (as given in data base table)  # added on 20-07-2011 -->
					
					 <a href="#" onclick="displayTemplate('16');return false;" class="component" id="hidden">
                        <?php echo _RSFORM_BACKEND_FORMS_EDIT_STARTLINETASK;?> <!-- defined in frontend/components/com_rsform/languages/defaul.php   added on 07-06-2011 -->
                    </a><div title="componentEdit" id="componentEdit16" class="componentEdit"></div>
					
					 <a href="#" onclick="displayTemplate('17');return false;" class="component" id="hidden">
                        <?php echo _RSFORM_BACKEND_FORMS_EDIT_ENDLINETASK;?> <!-- defined in frontend/components/com_rsform/languages/defaul.php   added on 07-06-2011 -->
                    </a><div title="componentEdit" id="componentEdit17" class="componentEdit"></div>
       ...
       $RSadapter->startTab(_RSFORM_BACKEND_FORMS_EDIT_TITLE_FORM_EDIT,"form-edit");
        ...
        <?php
        $RSadapter->endTab();
        $RSadapter->startTab('Cam Industry', 'Cam Assitant Integration');
        ?>
        <table cellpadding="4" cellspacing="0" border="0" class="adminform">
		<tr>
              <th colspan="2">Select Cam Industry</th>
        </tr>
          <tr>
              <td valign="top" align="left" width="100%">
                  <table>
                      <tr>
                        <td>Select Cam industry<br/>
			<select name="camindustry" id="camindustry">
			<option value="0" <?php if ($camidus->id=='0'){ echo 'selected'; } ?> > Select Industry </option>
			<?php foreach($camidus as $indus){
			if($row[camindustry]==$indus->id){ ?>
         <option value="<?php echo $indus->id ?>" selected> <?php echo $indus->industry_name; ?></option>
			<?php }else{ ?>
          ...
          <tr>
              <td valign="top" align="left" width="100%">
                  <table>
                      <tr>
                        <td>Require line Item Pricing<br/>
						<select name="line_item_price" id="line_item_price">
						<option value="0">Except 1st Line item</option>
						<option value="1" <?php if($row[line_item_price]=='1') echo"selected"; ?>>To all Line items</option>
						</select>
                        </td>
                      </tr>
                                 </table>
        ...
        <form action="<?php echo _RSFORM_BACKEND_SCRIPT_PATH;?>" method="post" name="adminForm" id="adminForm" onsubmit="transferItems();">
			...
			<input type="hidden" name="camindustry" value=""/>
						<input type="hidden" name="line_item_price" value=""/>
