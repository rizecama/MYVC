...
<div class="signup">
<label><strong>Where on the Property the work is to be performed:</strong> </label>
<textarea name="" readonly="readonly" style="width:275px; height:50px; font-family:arial; font-size:12px; color:#7D7D7D; border:1px solid #D7D7D7;"><?PHP
$RFP->work_perform = str_replace('Other','',$RFP->work_perform);
$RFP->work_perform_other = str_replace('Other-','',$RFP->work_perform_other);
$RFP->work_perform_other = str_replace('Please Specify','',$RFP->work_perform_other);
echo $RFP->work_perform.' '.$RFP->work_perform_other; ?></textarea>
</div>
...
<table width="100%">
  <tr>
    <td valign="top"><div class="signup">
...
<span class="blue_small"><strong>STATEMENT OF WORK:</strong></span><br />
...
<?PHP }  ?>
<div class="lineitem_pan"><input type="text" readonly="readonly"  style="width: 339px; background-color:#F7F7F7; color:#7D7D7D; border:1px solid #D7D7D7;" class="other_tfield"  value="<?PHP echo $TASKS[$i]->linetaskname; ?> 	"> <input type="text" readonly="readonly"  style="width: 311px; background-color:#F7F7F7; color:#7D7D7D; border:1px solid #D7D7D7; " class="other_tfield" value="<?PHP echo $TASKS[$i]->rfpreference; ?>"><p style="height:10px;"> </p>
<p style="background-color:#F7F7F7; padding:5px; margin:0px; border:1px solid #CDCDCD"><?PHP echo nl2br($TASKS[$i]->task_desc); ?><br /><br /></p><br/>
<?php
...
<span class="blue_small"><strong>Notes:</strong></span><br/>
<?php /*?><textarea name="NOTES_<?php echo $TASKS[$i]->task_id; ?>"  class="textarea" id='excep' style=" width:649px; height:120px;" ><?PHP echo html_entity_decode($TASKS[$i]->Notes); ?></textarea><?php */?>
