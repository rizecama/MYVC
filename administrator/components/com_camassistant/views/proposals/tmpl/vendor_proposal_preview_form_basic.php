...
<span class="blue_small">SCOPE OF WORK:</span><br />
<br />
...
<span class="grey_12" style="color:#FF0000" title="This is modified Line Item">VENDOR NOTES:
</span>
<?PHP } else { ?>
<span class="grey_12" style="float:left; width:350px;">VENDOR NOTES: <p><?PHP echo $TASKS[$i]->linetaskname; ?></p>
</span>
<?PHP }  ?>
...
<?PHP 
$files_cnt = count($TASKS[$i]->uploaded_file); if($files_cnt > 0) { for($f=0; $f<$files_cnt; $f++){?>
