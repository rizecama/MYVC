...
$pid = $_SESSION['pid'];
 ?>
<div align="right"><a href="index2.php?option=com_camassistant&controller=popupdocs&task=opendocs&amp;taskid=<?php echo $_SESSION['taskid'];?>&pid=<?php echo $pid;?>&tmpl=component"><img src="	images/back_admin.png" alt="info" /></a></div>
<div id="i_bar">
<div id="i_bar_txt">
...
<td align="center" valign="bottom"><a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=<?php echo $_REQUEST['Itemid']; ?>&propertyname=<?php print_r($sdocs->sdocTitle);  ?>&task=<?php echo $task; ?>&fileplace=<?php echo $fileplace; ?>&type=<?php echo $type; ?>&spath=<?php echo $path;?>&spid=<?php echo $sdocs->id; ?>&smid=<?php echo $sdocs->property_manager_id; ?>&pid=<?php echo $pid;?>&taskid=<?php echo $_SESSION['taskid'];?>&tmpl=component"><img src="images/images_<?php echo $exts; ?>.png" /></a></td>

<td align="left" valign="middle"><a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=<?php echo $_REQUEST['Itemid']; ?>&propertyname=<?php print_r($sdocs->sdocTitle);  ?>&task=<?php echo $task; ?>&fileplace=<?php echo $fileplace; ?>&type=<?php echo $type; ?>&spath=<?php echo $path;?>&spid=<?php echo $sdocs->id; ?>&smid=<?php echo $sdocs->property_manager_id; ?>&pid=<?php echo $pid;?>&taskid=<?php echo $_SESSION['taskid'];?>&tmpl=component"><?php echo str_replace('_',' ',$sdocs->sdocTitle);  ?></a>
</td>
...
<?php } else {?>
<a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=<?php echo $_REQUEST['Itemid']; ?>&propertyname=<?php print_r($sdocs->sdocTitle);  ?>&task=<?php echo $task; ?>&fileplace=<?php echo $fileplace; ?>&type=<?php echo $type; ?>&spath=<?php echo $path;?>&spid=<?php echo $sdocs->id; ?>&smid=<?php echo $sdocs->property_manager_id; ?>&pid=<?php echo $pid;?>&taskid=<?php echo $_SESSION['taskid'];?>&tmpl=component">OPEN</a>
<?php } ?>
</td>
</tr>
<?php }  else {?>
...
<tr class="table_blue_rowdots2">
<!--<td><img src="images/doc.png" /></td>-->
<td align="center" valign="bottom"><a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=<?php echo $_REQUEST['Itemid']; ?>&propertyname=<?php echo  $sdocs->property_name; ?>&task=sfiles&spid=<?php echo $sdocs->id; ?>&smid=<?php echo $sdocs->property_manager_id; ?>&taxid=<?php echo $sdocs->tax_id; ?>&taskid=<?php echo $_SESSION['taskid'];?>&tmpl=component"><img src="images/images_<?php echo $exts; ?>.png" /></a></td>

<td align="left" valign="middle"><a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=<?php echo $_REQUEST['Itemid']; ?>&propertyname=<?php echo  $sdocs->property_name; ?>&task=sfiles&spid=<?php echo $sdocs->id; ?>&smid=<?php echo $sdocs->property_manager_id; ?>&taxid=<?php echo $sdocs->tax_id; ?>&taskid=<?php echo $_SESSION['taskid'];?>&tmpl=component"><?php print_r($sdocs->property_name);  ?></a>
</td>
<td align="center" valign="middle"><a href="index2.php?option=com_camassistant&controller=popupdocs&Itemid=<?php echo $_REQUEST['Itemid']; ?>&propertyname=<?php echo  $sdocs->property_name; ?>&task=sfiles&spid=<?php echo $sdocs->id; ?>&smid=<?php echo $sdocs->property_manager_id; ?>&taxid=<?php echo $sdocs->tax_id; ?>&taskid=<?php echo $_SESSION['taskid'];?>&tmpl=component">OPEN</a>
</td>
</tr>
<?php }} ?>
