...
<span> <font style="font-weight:bold;"><?php echo "PAYMENT"; ?></font></span>
</div></div>
...
<tr height="20"></tr>
<tr><td width="50%">Amount:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="amount" id="amount" onblur="javascript: format_val(this.value);" /></td></tr>
<tr height="20"></tr>
<tr><td width="50%">Check ID:&nbsp;<input type="text" name="checkid" id="checkid" /></td></tr>
<tr height="20"></tr>
<tr><td><input type="button" value="SUBMIT" onclick="javascript:savepaymentpage();" /></td></tr></table>
