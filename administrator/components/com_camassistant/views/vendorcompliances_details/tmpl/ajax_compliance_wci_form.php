    ...
    <div class="lic-pan-right">
      <div class="comm">
	   <div class="in-pan">
        ...
        <input type="text" size="20" name="WCI_end_date[]" id="WCI_end_date<?PHP echo $WCI_title; ?>" value="" /><script type="text/javascript">G('#WCI_end_date<?PHP echo $WCI_title; ?>').datepicker({dateFormat: 'mm-dd-yy', changeYear: true,maxDate: "+5y",changeMonth:true});</script>
