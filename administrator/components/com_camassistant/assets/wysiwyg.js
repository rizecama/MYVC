...
// Images Directory
imagesDir = "components/com_camassistant/assets/icons/";

// CSS Directory
cssDir = "components/com_camassistant/assets/styles/";

// Popups Directory
popupsDir = "components/com_camassistant/assets/popups/";
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
    ...
    if (buttonName[i]) {
      ...
      var buttonImage          = buttonObj[2];
		...
		if(buttonID =='Bold' || buttonID =='Underline' || buttonID =='Italic' || buttonID =='InsertUnorderedList' || buttonID =='InsertOrderedList' || buttonID =='Justifyleft'                 || buttonID =='Justifycenter' || buttonID =='Justifyright' ){
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px; display:none;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  + '<iframe frameborder="0" id="wysiwyg' + n + '" onclick="javascript:getcursor();"></iframe>\n'
  + '</td></tr></table>\n';
