...
if($_GET['type']=="states")
{
		if($_GET['flag']=="1")
		{
			?>
             ...
             <img src="images/closecounty.gif" align="right"  onclick="closecounty('<?php echo $_GET['Fid'].$_GET['Len']; ?>')" /></div><?php } ?><select name="county[]" onchange="javascript:change();"  id="<?php echo $_GET['Fid']."_".$_GET['Len']; ?>" class="inputbox" style="width:252px"><option value="" >Please Select County</option>
			<option value="<?php echo $id."_All";?>">All Counties</option>
		 	<?php
