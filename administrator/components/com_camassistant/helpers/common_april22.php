...
if($_GET['type']=="states")
{
		for($i=0;$i<$_GET['fieldcnt'];$i++) 
		{
			...
			?>
			 <div style="padding-top:10px;" id="countydiv<?php echo $i;?>"><select name="county[]" <?PHP if($i==0) { ?> id="county_ID" <?PHP } ?>class="inputbox" style="width:282px"><option value="">Please Select County</option>
		 	<?php
