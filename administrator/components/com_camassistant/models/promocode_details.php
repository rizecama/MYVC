...
class promocode_detailsModelPromocode_details  extends Jmodel
{
	...
	function __construct()
	{
	  ...
	  $this->_table_prefix = '#__cam_promocode ';		
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT * FROM '.$this->_table_prefix.' WHERE id='.$_REQUEST[cid][0];
		return $query;
	}
