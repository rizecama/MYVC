...
<form action="<?php echo JRoute::_('index.php?option=com_rsfirewall&view=logs'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<tr>
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="left"><?php echo $this->hasKey($key) ? JText::_($key) : $row->code; ?><?php echo !empty($row->debug_variables) ? '<br /><b>'.JText::_('RSF_DEBUG_VARIABLES').'</b><br />'.$row->debug_variables : ''; ?></td>
