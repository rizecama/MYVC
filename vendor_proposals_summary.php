	...
	//echo $image; exit;
		$rateimage= 'http://vps54914.vps.ovh.ca'.DS.'components'.DS.'com_camassistant'.DS.'assets'.DS.'images'.DS.'rating'.DS;
		  ...
		  $htmlcontent .= '<tr><td height="15" style="'.$class.'">$'.$BID_Vendors_info[$v]->proposal_total_price.'</td></tr>
			...
			$htmlcontent .= '<br /><table><tr><td style="font-size:17px; align:left;"><font color="red">* </font>Designates exception for 1 or more line items. 	Please see vendor notes for details.</td></tr></table>';  
...
/***************************************** RFP LINE ITEMS AND VENDOR RESPONSES ****************************************/
		...
		/***************** CODE TO GET VENDOR RESPONSE PRICES FOR RFP OTHER ITEM PRICE  ****************************/
		 ...
		 echo '123'; echo count($vendors_cnt);
			...
			//$htmlcontentotherprice .='<tr><td colspan="2"><table border="1" width="100%" cellspacing="0" cellpadding="3"><tr><td style="font-size:19px; text-align: left; ">';	
							...
							$db =& JFactory::getDBO();
							echo $other_price_sql = "SELECT `price_other_items` FROM #__cam_vendor_proposals  where rfpno='".$RFP_info->id."' AND proposedvendorid  ='".$vendors_cnt[$z]->proposedvendorid. "' AND Alt_bid != 'yes' "; 
